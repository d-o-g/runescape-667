...
public final class OverlayManager {
    ...
    public static void render(@OriginalArg(0) int screenY, @OriginalArg(1) int screenWidth, @OriginalArg(4) int screenX, @OriginalArg(5) int screenHeight) {
        ...
        if (CutsceneManager.state == 3) {
            ...
            count = NPCList.localNpcCount + playerCount;
        }
        ...
        for (@Pc(27) int i = 0; i < count; i++) {
            ...
            if (hitmarkpos[0] >= 0) {
                ...
                if (entity.visible || TimeUtils.clock >= entity.healthClock) {
                    ...
                    Static682.method8927(y, height + y, x, hitbarFirst.scaleWidth() + x);
                }
                ...
                if (!entity.visible) {
                    if (entity.timerbarEnd > TimeUtils.clock) {
                        ...
                        Static682.method8927(y, spriteHeight + y, x, bottom.scaleWidth() + x);
                    ...
                    if (npcType != null) {
                        if (npcType.headIcon >= 0 && Sprites.headiconsPrayer.length > npcType.headIcon) {
                            ...
                            Static682.method8927(y, headicon.scaleHeight() + y, screenX + hitmarkpos[0] - (headicon.getWidth() >> 1), hitmarkpos[0] + screenX - (headicon.getWidth() >> 1) + headicon.scaleWidth());
                        ...
                        if (player.pkIcon != -1) {
                            ...
                            Static682.method8927(y, headicon.scaleHeight() + y, hitmarkpos[0] + screenX + -12, hitmarkpos[0] + screenX + headicon.scaleWidth() - 12);
                        ...
                        if (player.prayerIcon != -1) {
                            ...
                            Static682.method8927(y, y + headicon.scaleHeight(), hitmarkpos[0] + screenX + -12, hitmarkpos[0] + screenX + headicon.scaleWidth() - 12);
                    ...
                    if (i >= 0) {
                        ...
                        for (@Pc(504) int j = 0; j < hintArrows.length; j++) {
                            ...
                            if (hintArrow != null && hintArrow.type == HintArrowType.PLAYER && hintArrow.entity == playerIndices[i]) {
                                ...
                                Static682.method8927(y - headicon.getHeight(), y - headicon.getHeight() - -headicon.scaleHeight(), screenX + hitmarkpos[0] - 12, hitmarkpos[0] + (screenX - 12) - -headicon.scaleWidth());
                            }
                        }
                    ...
                    for (@Pc(504) int j = 0; j < hintArrows.length; j++) {
                        ...
                        if (hintArrow != null && hintArrow.type == HintArrowType.NPC && NPCList.localNpcIndices[i - playerCount] == hintArrow.entity) {
                            ...
                            if (draw) {
                                ...
                                Static682.method8927(y - headicon.getHeight(), -headicon.getHeight() + (y - -headicon.scaleHeight()), screenX + hitmarkpos[0] - 12, screenX + hitmarkpos[0] - (12 - headicon.scaleWidth()));
                            }
                        }
                    }
