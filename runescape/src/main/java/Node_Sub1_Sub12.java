...
public final class Node_Sub1_Sub12 extends Node_Sub1 {

    @OriginalMember(owner = "client!jk", name = "M", descriptor = "I")
    public int anInt4855 = 1;

    @OriginalMember(owner = "client!jk", name = "I", descriptor = "I")
    public int anInt4850 = 1;

    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "()V")
    public Node_Sub1_Sub12() {
        super(1, false);
    }
    ...
    public void method9416(@OriginalArg(0) boolean arg0, @OriginalArg(1) Node_Sub21 arg1, @OriginalArg(2) int arg2) {
        ...
        if (arg2 == 0) {
            this.anInt4850 = arg1.method7396();
        } else if (arg2 == 1) {
            this.anInt4855 = arg1.method7396();
        } else if (arg2 == 2) {
