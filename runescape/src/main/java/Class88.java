...
public final class Class88 {
    ...
    public void method2235(@OriginalArg(0) byte[] arg0) {
        ...
        for (@Pc(633) int local633 = 0; local633 < this.anInt2372; local633++) {
            ...
            if ((local638 & 0x1) != 0) {
                local640 = local13.gsmarts();
            }
            @Pc(653) int local653 = 0;
            if ((local638 & 0x2) != 0) {
                local653 = local18.gsmarts();
            }
        ...
        for (@Pc(877) int local877 = 0; local877 < this.anInt2362; local877++) {
            local882 = local13.g1();
            if (local882 == 1) {
                local869 = (short) (local8.gsmarts() + local875);
                local871 = (short) (local8.gsmarts() + local869);
                local873 = (short) (local871 + local8.gsmarts());
                local875 = local873;
            ...
            if (local882 == 2) {
                local871 = local873;
                local873 = (short) (local8.gsmarts() + local875);
                this.aShortArray27[local877] = local869;
                local875 = local873;
                this.aShortArray24[local877] = local871;
                this.aShortArray26[local877] = local873;
            ...
            if (local882 == 4) {
                ...
                local869 = local871;
                local873 = (short) (local875 + local8.gsmarts());
                local871 = local1055;
                this.aShortArray27[local877] = local869;
                local875 = local873;
    ...
    public void method2242(@OriginalArg(1) byte[] arg0) {
        ...
        for (@Pc(360) int local360 = 0; local360 < this.anInt2372; local360++) {
            ...
            local367 = 0;
            if ((local365 & 0x1) != 0) {
                local367 = local17.gsmarts();
            }
            @Pc(377) int local377 = 0;
            if ((local365 & 0x2) != 0) {
                local377 = local22.gsmarts();
            }
        ...
        for (@Pc(617) int local617 = 0; local617 < this.anInt2362; local617++) {
            local622 = local17.g1();
            if (local622 == 1) {
                local609 = (short) (local615 + local12.gsmarts());
                local611 = (short) (local12.gsmarts() + local609);
                local613 = (short) (local12.gsmarts() + local611);
                local615 = local613;
            ...
            if (local622 == 2) {
                local611 = local613;
                local613 = (short) (local12.gsmarts() + local615);
                local615 = local613;
                this.aShortArray27[local617] = local609;
                this.aShortArray24[local617] = local611;
                this.aShortArray26[local617] = local613;
            ...
            if (local622 == 3) {
                local609 = local613;
                local613 = (short) (local615 + local12.gsmarts());
                this.aShortArray27[local617] = local609;
                local615 = local613;
                this.aShortArray24[local617] = local611;
                this.aShortArray26[local617] = local613;
