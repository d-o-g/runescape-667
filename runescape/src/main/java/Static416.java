...
public final class Static416 {
                ...
                for (@Pc(92) int local92 = 0; local92 < Static662.anInt9843; local92++) {
                    ...
                    if (local101 != null) {
                        ...
                        if (local101.aShort84 < 0) {
                            ...
                            local161 = Static706.aGroundArray3[local25].method7869(local28, local92);
                            while (local137 > 0 && local153 != null && local153.aShort84 < 0 && local101.aShort84 == local153.aShort84 && local101.aShort86 == local153.aShort86 && Static706.aGroundArray3[local25].method7869(local137 - 1, local92) == local161 && (local137 - 1 <= 0 || local161 == Static706.aGroundArray3[local25].method7869(local137 - 2, local92))) {
                                local137--;
                                local153 = Static334.aClass291ArrayArrayArray1[local25][local92][local137 - 1];
                            }
                            for (local153 = Static334.aClass291ArrayArrayArray1[local25][local92][local28 + 1]; Static662.anInt9843 > local139 && local153 != null && local153.aShort84 < 0 && local101.aShort84 == local153.aShort84 && local101.aShort86 == local153.aShort86 && local161 == Static706.aGroundArray3[local25].method7869(local139 + 1, local92) && (Static662.anInt9843 <= local139 + 1 || local161 == Static706.aGroundArray3[local25].method7869(local139 + 2, local92)); local153 = Static334.aClass291ArrayArrayArray1[local25][local92][local139 + 1]) {
                                local139++;
                            }
                            local328 = local25 + 1 - local25;
                            local343 = Static706.aGroundArray3[local129 ? local25 + 1 : local25].method7869(local137, local92);
                            local350 = local343 + local101.aShort84 * local328;
                            local367 = Static706.aGroundArray3[local129 ? local25 + 1 : local25].method7869(local139 + 1, local92);
                        ...
                        if (local101.aShort83 < 0) {
                            ...
                            local161 = Static706.aGroundArray3[local25].method7869(local28, local92);
                            while (local137 > 0 && local153 != null && local153.aShort83 < 0 && local153.aShort83 == local101.aShort83 && local153.aShort85 == local101.aShort85 && local161 == Static706.aGroundArray3[local25].method7869(local28, local137 - 1) && (local137 - 1 <= 0 || local161 == Static706.aGroundArray3[local25].method7869(local28, local137 - 2))) {
                                local137--;
                                local153 = Static334.aClass291ArrayArrayArray1[local25][local137 - 1][local28];
                            }
                            for (local153 = Static334.aClass291ArrayArrayArray1[local25][local92 + 1][local28]; local139 < Static619.anInt1566 && local153 != null && local153.aShort83 < 0 && local101.aShort83 == local153.aShort83 && local101.aShort85 == local153.aShort85 && Static706.aGroundArray3[local25].method7869(local28, local139 + 1) == local161 && (local139 + 1 >= Static619.anInt1566 || local161 == Static706.aGroundArray3[local25].method7869(local28, local139 + 2)); local153 = Static334.aClass291ArrayArrayArray1[local25][local139 + 1][local28]) {
                                local139++;
                            }
                            local328 = local25 + 1 - local25;
                            local343 = Static706.aGroundArray3[local129 ? local25 + 1 : local25].method7869(local28, local137);
                            local350 = local328 * local101.aShort83 + local343;
                            local367 = Static706.aGroundArray3[local129 ? local25 + 1 : local25].method7869(local28, local139 + 1);
    ...
    public static void method5707(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) long arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) String arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7, @OriginalArg(8) int arg8, @OriginalArg(9) String arg9, @OriginalArg(10) long arg10, @OriginalArg(12) boolean arg11) {
        if (!Static400.aBoolean622 && Static594.anInt8777 < 500) {
            ...
            @Pc(36) Node_Sub2_Sub16 local36 = new Node_Sub2_Sub16(arg5, arg9, local20, arg6, arg1, arg2, arg3, arg4, arg7, arg0, arg10, arg11);
