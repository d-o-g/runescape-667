...
public final class Static249 {
    ...
    public static int method3536(@OriginalArg(1) DoublyLinkedNode_Sub2_Sub16 arg0) {
        ...
        if (Static245.method8635(arg0.anInt7314)) {
            local17 = Static419.objTypeList.list((int) arg0.aLong233).quests;
        } else if (arg0.anInt7317 != -1) {
            local17 = Static419.objTypeList.list(arg0.anInt7317).quests;
    ...
    public static boolean method3537(@OriginalArg(1) boolean arg0) {
        ...
        if (arg0 == local13) {
            ...
            ClientOptions.instance.method5104(arg0 ? 1 : 0, ClientOptions.instance.aClass57_Sub20_1);
