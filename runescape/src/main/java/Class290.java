...
public final class Class290 implements Interface13 {
    ...
    public void method7749() {
        ...
        if (this.aClass235_1.aBoolean454) {
            Static163.aToolkit_17.method7976(local35, local49, this.aClass235_1.anInt5976, this.aClass235_1.anInt5970, this.aClass235_1.anInt5972, 0);
        }
        local49 += this.method6520(Static180.aClass14_3, local19.aString103, local35, local49) * 12;
        local49 += 8;
        if (this.aClass235_1.aBoolean454) {
            Static163.aToolkit_17.method7951(local35, local49, this.aClass235_1.anInt5976 + local35 - 1, local49, this.aClass235_1.anInt5972, 0);
        }
        local49++;
