...
public final class Class144 {
    ...
    public DoublyLinkedList.Node aClass2_Sub2_31;
    ...
    public final DoublyLinkedList.Node[] aClass2_Sub2Array1;
    ...
    public Class144(@OriginalArg(0) int arg0) {
        this.aClass2_Sub2Array1 = new DoublyLinkedList.Node[arg0];
        this.anInt3417 = arg0;
        for (@Pc(10) int local10 = 0; local10 < arg0; local10++) {
            @Pc(20) DoublyLinkedList.Node local20 = this.aClass2_Sub2Array1[local10] = new DoublyLinkedList.Node();
    ...
    public void method3094(@OriginalArg(1) DoublyLinkedList.Node arg0, @OriginalArg(2) long arg1) {
        if (arg0.prev2 != null) {
            arg0.unlink2();
        }
        @Pc(28) DoublyLinkedList.Node local28 = this.aClass2_Sub2Array1[(int) ((long) (this.anInt3417 - 1) & arg1)];
        arg0.next2 = local28;
    ...
    public DoublyLinkedList.Node method3095(@OriginalArg(0) long arg0) {
        this.aLong115 = arg0;
        @Pc(20) DoublyLinkedList.Node local20 = this.aClass2_Sub2Array1[(int) (arg0 & (long) (this.anInt3417 - 1))];
        for (this.aClass2_Sub2_31 = local20.next2; this.aClass2_Sub2_31 != local20; this.aClass2_Sub2_31 = this.aClass2_Sub2_31.next2) {
            if (arg0 == this.aClass2_Sub2_31.key2) {
                @Pc(41) DoublyLinkedList.Node local41 = this.aClass2_Sub2_31;
    ...
    public DoublyLinkedList.Node method3096() {
        if (this.aClass2_Sub2_31 == null) {
            return null;
        }
        @Pc(24) DoublyLinkedList.Node local24 = this.aClass2_Sub2Array1[(int) (this.aLong115 & (long) (this.anInt3417 - 1))];
        while (this.aClass2_Sub2_31 != local24) {
            if (this.aLong115 == this.aClass2_Sub2_31.key2) {
                @Pc(38) DoublyLinkedList.Node local38 = this.aClass2_Sub2_31;
                this.aClass2_Sub2_31 = this.aClass2_Sub2_31.next2;
                return local38;
            }
            this.aClass2_Sub2_31 = this.aClass2_Sub2_31.next2;
