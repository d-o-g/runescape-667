...
public final class Class339 {
    ...
    public Class339() {
        this.aNode_271.next = this.aNode_271;
        this.aNode_271.prev = this.aNode_271;
    }
    ...
    public void method7697(@OriginalArg(0) Node arg0) {
        ...
        arg0.next = this.aNode_271.next;
        arg0.prev = this.aNode_271;
        arg0.prev.next = arg0;
        arg0.next.prev = arg0;
    }
    ...
    public Node method7699(@OriginalArg(0) int arg0) {
        @Pc(7) Node local7 = this.aNode_271.next;
        if (arg0 != 65280) {
            this.aNode_272 = null;
        }
    ...
    public int method7701() {
        @Pc(13) int local13 = 0;
        @Pc(17) Node local17 = this.aNode_271.next;
    ...
    public boolean method7702() {
        return this.aNode_271 == this.aNode_271.next;
    }
    ...
    public void method7703(@OriginalArg(0) Node arg0, @OriginalArg(1) Class339 arg1) {
        @Pc(7) Node local7 = this.aNode_271.prev;
        this.aNode_271.prev = arg0.prev;
        arg0.prev.next = this.aNode_271;
        if (arg0 != this.aNode_271) {
            arg0.prev = arg1.aNode_271.prev;
            arg0.prev.next = arg0;
            local7.next = arg1.aNode_271;
            arg1.aNode_271.prev = local7;
        }
    }
    ...
    public void method7711(@OriginalArg(1) Node arg0) {
        ...
        arg0.next = this.aNode_271;
        arg0.prev = this.aNode_271.prev;
        arg0.prev.next = arg0;
        arg0.next.prev = arg0;
    }
}
