...
public final class Class413 {
	...
	public static final Hashtable aHashtable9 = new Hashtable(16);
	...
	public static File method9490(@OriginalArg(1) String arg0, @OriginalArg(2) int arg1, @OriginalArg(3) String arg2) {
		if (!aBoolean835) {
