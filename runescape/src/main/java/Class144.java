...
public final class Class144 {
    ...
    public Node_Sub2 aClass2_Sub2_31;
    ...
    public final Node_Sub2[] aClass2_Sub2Array1;
    ...
    public Class144(@OriginalArg(0) int arg0) {
        this.aClass2_Sub2Array1 = new Node_Sub2[arg0];
        this.anInt3417 = arg0;
        for (@Pc(10) int local10 = 0; local10 < arg0; local10++) {
            @Pc(20) Node_Sub2 local20 = this.aClass2_Sub2Array1[local10] = new Node_Sub2();
    ...
    public void method3094(@OriginalArg(1) Node_Sub2 arg0, @OriginalArg(2) long arg1) {
        if (arg0.aClass2_Sub2_67 != null) {
            arg0.method9260();
        }
        @Pc(28) Node_Sub2 local28 = this.aClass2_Sub2Array1[(int) ((long) (this.anInt3417 - 1) & arg1)];
    ...
    public Node_Sub2 method3095(@OriginalArg(0) long arg0) {
        this.aLong115 = arg0;
        @Pc(20) Node_Sub2 local20 = this.aClass2_Sub2Array1[(int) (arg0 & (long) (this.anInt3417 - 1))];
        for (this.aClass2_Sub2_31 = local20.aClass2_Sub2_66; this.aClass2_Sub2_31 != local20; this.aClass2_Sub2_31 = this.aClass2_Sub2_31.aClass2_Sub2_66) {
            if (arg0 == this.aClass2_Sub2_31.aLong325) {
                @Pc(41) Node_Sub2 local41 = this.aClass2_Sub2_31;
    ...
    public Node_Sub2 method3096() {
        if (this.aClass2_Sub2_31 == null) {
            return null;
        }
        @Pc(24) Node_Sub2 local24 = this.aClass2_Sub2Array1[(int) (this.aLong115 & (long) (this.anInt3417 - 1))];
        while (this.aClass2_Sub2_31 != local24) {
            if (this.aLong115 == this.aClass2_Sub2_31.aLong325) {
                @Pc(38) Node_Sub2 local38 = this.aClass2_Sub2_31;
                this.aClass2_Sub2_31 = this.aClass2_Sub2_31.aClass2_Sub2_66;
                return local38;
            }
            this.aClass2_Sub2_31 = this.aClass2_Sub2_31.aClass2_Sub2_66;
