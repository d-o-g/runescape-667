...
public final class Node_Sub2_Sub4 extends Node_Sub2 {
    ...
    public Node_Sub2_Sub4(@OriginalArg(0) String arg0) {
        this.aString10 = arg0;
    ...
    public int method1468() {
        return this.aClass192_3.aClass2_Sub2_36.aClass2_Sub2_66 == this.aClass192_3.aClass2_Sub2_36 ? -1 : ((Node_Sub2_Sub16) this.aClass192_3.aClass2_Sub2_36.aClass2_Sub2_66).anInt7314;
    }

    @OriginalMember(owner = "client!cba", name = "b", descriptor = "(ILclient!pg;)Z")
    public boolean method1469(@OriginalArg(1) Node_Sub2_Sub16 arg0) {
    ...
    public boolean method1471(@OriginalArg(1) Node_Sub2_Sub16 arg0) {
        @Pc(5) boolean local5 = true;
        arg0.method9260();
        @Pc(21) Node_Sub2_Sub16 local21 = (Node_Sub2_Sub16) this.aClass192_3.method4352();
        while (local21 != null) {
            ...
            local21 = (Node_Sub2_Sub16) this.aClass192_3.method4350();
            local5 = false;
        }
