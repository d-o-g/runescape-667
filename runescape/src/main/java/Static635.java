...
public final class Static635 {
    ...
    public static void method8380(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
        if (arg1) {
            @Pc(26) ClientMessage local26 = Static293.method4335(Static321.aClass345_64, Static405.A_SERVER_CONNECTION___2.aClass186_1);
            local26.buffer.p2(arg0);
            Static405.A_SERVER_CONNECTION___2.send(local26);
        } else {
