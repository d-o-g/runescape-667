...
public final class Protocol {
    ...
    public static boolean readServerMessage(@OriginalArg(0) ServerConnection arg0) throws IOException {
        ...
        @Pc(277) int local277;
        if (ServerProt.IF_CLOSESUB == arg0.currentProt) {
            ...
            if (arg0.currentProt == ServerProt.IF_SETCLICKMASK) {
                ...
                arg0.currentProt = null;
                return true;
            } else if (ServerProt.IF_SETSCROLLPOS == arg0.currentProt) {
                ...
                arg0.currentProt = null;
                return true;
            } else if (ServerProt.IF_SETVIDEO == arg0.currentProt) {
                local277 = bitPacket.g4_alt1();
                ...
                @Pc(526) int local526;
                if (arg0.currentProt == ServerProt.IF_SETPOSITION) {
                    ...
                    arg0.currentProt = null;
                    return true;
                } else if (arg0.currentProt == ServerProt.CLANSETTINGS_FULL) {
                    ...
                    @Pc(667) int local667;
                    if (arg0.currentProt == ServerProt.MESSAGE_QUICKCHAT_FRIENDCHAT) {
                        local446 = bitPacket.g1() == 1;
                        ...
                        arg0.currentProt = null;
                        return true;
                    } else if (arg0.currentProt == ServerProt.WORLDLIST_FETCH_REPLY) {
                        local446 = bitPacket.g1() == 1;
                        ...
                        if (arg0.currentProt == ServerProt.LOYALTY_UPDATE) {
                        ...
                        if (ServerProt.VARP_SMALL == arg0.currentProt) {
                            ...
                            arg0.currentProt = null;
                            return true;
                        } else if (arg0.currentProt == ServerProt.RESET_CLIENT_VARCACHE) {
                            ...
                            if (ServerProt.MESSAGE_QUICKCHAT_CLANCHANNEL == arg0.currentProt) {
                                local446 = bitPacket.g1() == 1;
                                local627 = bitPacket.gjstr();
                                ...
                                arg0.currentProt = null;
                                return true;
                            } else if (arg0.currentProt == ServerProt.RESET_ANIMS) {
                                ...
                                arg0.currentProt = null;
                                return true;
                            } else if (ServerProt.VARCLAN_INIT == arg0.currentProt) {
                                Static279.anObjectArray35 = new Object[VarClanSettingTypeList.instance.num];
                                arg0.currentProt = null;
                                return true;
                            } else if (ServerProt.REDUCE_ATTACK_PRIORITY == arg0.currentProt) {
                                Static324.reduceAttackPriority = bitPacket.g1_alt3() == 1;
                                arg0.currentProt = null;
                                return true;
                            } else if (arg0.currentProt == ServerProt.MINIMAP_TOGGLE) {
                                Minimap.toggle = bitPacket.g1();
                                arg0.currentProt = null;
                                return true;
                            } else if (arg0.currentProt == ServerProt.IF_SETMODEL) {
                                local277 = bitPacket.g4_alt2();
                                local100 = bitPacket.g2_alt2();
                                if (local100 == 65535) {
                                    local100 = -1;
                                ...
                                if (arg0.currentProt == ServerProt.UPDATE_FRIENDLIST) {
                                    ...
                                    arg0.currentProt = null;
                                    return true;
                                } else if (ServerProt.SOUND_MIXBUSS_SETLEVEL == arg0.currentProt) {
                                    ...
                                    if (arg0.currentProt == ServerProt.MESSAGE_QUICKCHAT_PRIVATE_ECHO) {
                                        ...
                                        arg0.currentProt = null;
                                        return true;
                                    } else if (arg0.currentProt == ServerProt.VORBIS_SOUND) {
                                        local277 = bitPacket.g2();
                                        if (local277 == 65535) {
                                            local277 = -1;
                                        }
                                        ...
                                        arg0.currentProt = null;
                                        return true;
                                    } else if (ServerProt.SERVER_PROT_141 == arg0.currentProt) {
                                        local277 = bitPacket.ig2();
                                        Static574.method7573();
                                        VideoTypeList.method9267(local277);
                                        arg0.currentProt = null;
                                        return true;
                                    } else if (arg0.currentProt == ServerProt.IF_SETTEXTFONT) {
                                        local277 = bitPacket.g4_alt2();
                                        ...
                                        if (arg0.currentProt == ServerProt.UPDATE_INV_FULL) {
                                            local277 = bitPacket.g2();
                                            local100 = bitPacket.g1();
                                            ...
                                            arg0.currentProt = null;
                                            return true;
                                        } else if (ServerProt.CHANGE_LOBBY == arg0.currentProt) {
                                            local277 = bitPacket.g4();
                                            Static439.hostnameResource = GameShell.signLink.lookupHostname(local277);
                                            arg0.currentProt = null;
                                            return true;
                                        } else if (ServerProt.CLIENT_SETVARC_LARGE == arg0.currentProt) {
                                            local277 = bitPacket.ig2();
                                            ...
                                            arg0.currentProt = null;
                                            return true;
                                        } else if (arg0.currentProt == ServerProt.IF_SETPLAYERHEAD_IGNOREWORN) {
                                            ...
                                            arg0.currentProt = null;
                                            return true;
                                        } else if (arg0.currentProt == ServerProt.IF_SETPLAYERMODEL_SELF) {
                                            local277 = bitPacket.g4();
                                            Static574.method7573();
                                            DelayedStateChange.method6462(PlayerList.activePlayerSlot, 5, 0, local277);
                                            arg0.currentProt = null;
                                            return true;
                                        } else if (ServerProt.LOGOUT_FULL == arg0.currentProt) {
                                            LoginManager.logout(false);
                                            arg0.currentProt = null;
                                            return false;
                                        } else if (arg0.currentProt == ServerProt.REBUILD_REGION) {
                                            Static466.rebuildRegion();
                                            arg0.currentProt = null;
                                            return false;
                                        } else if (arg0.currentProt == ServerProt.UPDATE_INV_PARTIAL) {
                                            local277 = bitPacket.g2();
                                            local100 = bitPacket.g1();
                                            local2080 = (local100 & 0x1) == 1;
                                            ...
                                            arg0.currentProt = null;
                                            return true;
                                        } else if (ServerProt.RUNCLIENTSCRIPT == arg0.currentProt) {
                                            local1937 = bitPacket.gjstr();
                                            ...
                                            arg0.currentProt = null;
                                            return true;
                                        } else if (arg0.currentProt == ServerProt.IF_SETGRAPHIC) {
                                            local277 = bitPacket.ig2();
                                            local100 = bitPacket.g4();
                                            Static574.method7573();
                                            ...
                                            arg0.currentProt = null;
                                            return true;
                                        } else if (arg0.currentProt == ServerProt.UPDATE_RUNWEIGHT) {
                                            Static494.anInt7404 = bitPacket.g2s();
                                            arg0.currentProt = null;
                                            Static321.lastMiscTransmit = World.tick;
                                            return true;
                                        } else if (ServerProt.IF_OPENTOP == arg0.currentProt) {
                                            ...
                                            arg0.currentProt = null;
                                            return true;
                                        } else if (ServerProt.UPDATE_SITESETTINGS == arg0.currentProt) {
                                            Static708.method9230(bitPacket.gjstr());
                                            arg0.currentProt = null;
                                            return true;
                                        } else if (arg0.currentProt == ServerProt.NPC_ANIM_SPECIFIC) {
                                            ...
                                            arg0.currentProt = null;
                                            return true;
                                        } else if (arg0.currentProt == ServerProt.UPDATE_REBOOT_TIMER) {
                                            ...
                                            Static321.lastMiscTransmit = World.tick;
                                            return true;
                                        } else if (ServerProt.SERVER_PROT_100 == arg0.currentProt) {
                                            ...
                                            arg0.currentProt = null;
                                            return true;
                                        } else if (arg0.currentProt == ServerProt.CLANCHANNEL_DELTA) {
                                            ...
                                            arg0.currentProt = null;
                                            return true;
                                        } else if (ServerProt.IF_SETCOLOUR == arg0.currentProt) {
                                            local277 = bitPacket.g4_alt2();
                                            local100 = bitPacket.g2();
                                            Static574.method7573();
                                            ...
                                            arg0.currentProt = null;
                                            return true;
                                        } else if (ServerProt.SERVER_PROT_92 == arg0.currentProt) {
                                            local277 = bitPacket.g4_alt1();
                                            Static574.method7573();
                                            if (local277 == -1) {
                                                Camera.anInt10383 = -1;
                                            ...
                                            arg0.currentProt = null;
                                            return true;
                                        } else if (arg0.currentProt == ServerProt.VORBIS_SPEECH_STOP) {
                                            Static696.method9035();
                                            arg0.currentProt = null;
                                            return true;
                                        } else if (ServerProt.VARCLAN_BYTE == arg0.currentProt) {
                                            local277 = bitPacket.g2();
                                            ...
                                            if (ServerProt.URL_OPEN == arg0.currentProt) {
                                                ...
                                                arg0.currentProt = null;
                                                return true;
                                            } else if (arg0.currentProt == ServerProt.MESSAGE_QUICKCHAT_PRIVATE) {
                                                local446 = bitPacket.g1() == 1;
                                                local627 = bitPacket.gjstr();
                                                local629 = local627;
                                                if (local446) {
                                                ...
                                                arg0.currentProt = null;
                                                return true;
                                            } else if (ServerProt.UPDATE_STAT == arg0.currentProt) {
                                                local277 = bitPacket.g1_alt3();
                                                local100 = bitPacket.g1_alt1();
                                                ...
                                                arg0.currentProt = null;
                                                return true;
                                            } else if (arg0.currentProt == ServerProt.CHAT_FILTER_SETTINGS_PRIVATECHAT) {
                                                Static726.aClass280_7 = Class280.method2864(bitPacket.g1());
                                                arg0.currentProt = null;
                                                return true;
                                            } else if (ServerProt.IF_SETRECOL == arg0.currentProt) {
                                                local277 = bitPacket.g1_alt3();
                                                local100 = bitPacket.g4();
                                                ...
                                                if (arg0.currentProt == ServerProt.MESSAGE_CLANCHANNEL) {
                                                    local446 = bitPacket.g1() == 1;
                                                    local627 = bitPacket.gjstr();
                                                    local983 = bitPacket.g2();
                                                    local988 = bitPacket.g3();
                                                    ...
                                                    arg0.currentProt = null;
                                                    return true;
                                                } else if (arg0.currentProt == ServerProt.HINT_ARROW) {
                                                    ...
                                                    arg0.currentProt = null;
                                                    return true;
                                                } else if (arg0.currentProt == ServerProt.SETDRAWORDER) {
                                                    local277 = bitPacket.g1_alt3();
                                                    Static574.method7573();
                                                    arg0.currentProt = null;
                                                    Static150.anInt2632 = local277;
                                                    return true;
                                                } else if (arg0.currentProt == ServerProt.UPDATE_UID192) {
                                                    bitPacket.pos += 28;
                                                    ...
                                                    arg0.currentProt = null;
                                                    return true;
                                                } else if (arg0.currentProt == ServerProt.IF_SETOBJECT) {
                                                    local277 = bitPacket.ig2();
                                                    if (local277 == 65535) {
                                                        local277 = -1;
                                                    }
                                                    ...
                                                    arg0.currentProt = null;
                                                    return true;
                                                } else if (arg0.currentProt == ServerProt.SERVER_PROT_113) {
                                                    local277 = bitPacket.g1_alt3();
                                                    local100 = bitPacket.g2();
                                                    Static574.method7573();
                                                    ...
                                                    arg0.currentProt = null;
                                                    return true;
                                                } else if (arg0.currentProt == ServerProt.SHOW_FACE_HERE) {
                                                    local446 = bitPacket.g1_alt2() == 1;
                                                    Static574.method7573();
                                                    Static501.aBoolean576 = local446;
                                                    arg0.currentProt = null;
                                                    return true;
                                                } else if (arg0.currentProt == ServerProt.UPDATE_STOCKMARKET_SLOT) {
                                                    local277 = bitPacket.g1();
                                                    if (bitPacket.g1() == 0) {
                                                    ...
                                                    arg0.currentProt = null;
                                                    return true;
                                                } else if (ServerProt.VIDEO_STOP == arg0.currentProt) {
                                                    local277 = bitPacket.g2_alt3();
                                                    Static574.method7573();
                                                    ...
                                                    if (arg0.currentProt == ServerProt.MESSAGE_GAME) {
                                                        ...
                                                        arg0.currentProt = null;
                                                        return true;
                                                    } else if (arg0.currentProt == ServerProt.VARCLAN_CLEAR) {
                                                        arg0.currentProt = null;
                                                        Static279.anObjectArray35 = null;
                                                        return true;
                                                    } else if (ServerProt.CLIENT_SETVARCSTR_SMALL == arg0.currentProt) {
                                                        local277 = bitPacket.g2_alt3();
                                                        local627 = bitPacket.gjstr();
                                                        Static574.method7573();
                                                        ...
                                                        arg0.currentProt = null;
                                                        return true;
                                                    } else if (arg0.currentProt == ServerProt.CAM_SHAKE) {
                                                        local277 = bitPacket.g1_alt3();
                                                        local100 = bitPacket.g1_alt1();
                                                        local526 = bitPacket.g2_alt3();
                                                        ...
                                                        if (arg0.currentProt == ServerProt.IF_SETTARGETPARAM) {
                                                            local277 = bitPacket.g2_alt2();
                                                            if (local277 == 65535) {
                                                                local277 = -1;
                                                            }
                                                        ...
                                                        if (arg0.currentProt == ServerProt.VARCLAN_LONG) {
                                                            local277 = bitPacket.g2();
                                                            ...
                                                            arg0.currentProt = null;
                                                            return true;
                                                        } else if (ServerProt.SERVER_PROT_115 == arg0.currentProt) {
                                                            local277 = bitPacket.ig2();
                                                            local100 = bitPacket.g2_alt3();
                                                            ...
                                                            if (arg0.currentProt == ServerProt.SPOTANIM_SPECIFIC) {
                                                                local277 = bitPacket.g2_alt2();
                                                                local100 = bitPacket.g4_alt3();
                                                                ...
                                                                arg0.currentProt = null;
                                                                return true;
                                                            } else if (ServerProt.IF_SETNPCHEAD == arg0.currentProt) {
                                                                local277 = bitPacket.g4();
                                                                local100 = bitPacket.ig2();
                                                                if (local100 == 65535) {
                                                                    local100 = -1;
                                                                ...
                                                                arg0.currentProt = null;
                                                                return true;
                                                            } else if (ServerProt.REFLECTION_CHECKER == arg0.currentProt) {
                                                                Static480.method6468(bitPacket, GameShell.signLink, arg0.currentPacketSize);
                                                                arg0.currentProt = null;
                                                                return true;
                                                            } else if (ServerProt.CAM_RESET == arg0.currentProt) {
                                                                Static574.method7573();
                                                                Camera.reset();
                                                                arg0.currentProt = null;
                                                                return true;
                                                                ...
                                                                if (ServerProt.IF_MOVESUB == arg0.currentProt) {
                                                                    local277 = bitPacket.g4_alt2();
                                                                    local100 = bitPacket.g4_alt3();
                                                                    Static574.method7573();
                                                                    ...
                                                                    arg0.currentProt = null;
                                                                    return true;
                                                                } else if (arg0.currentProt == ServerProt.IF_OPENSUB) {
                                                                    local277 = bitPacket.g2_alt3();
                                                                    local100 = bitPacket.g4_alt1();
                                                                    local526 = bitPacket.g1();
                                                                    Static574.method7573();
                                                                    ...
                                                                    arg0.currentProt = null;
                                                                    return true;
                                                                } else if (arg0.currentProt == ServerProt.CAM_LOOKAT) {
                                                                    local277 = bitPacket.g1_alt2();
                                                                    ...
                                                                    arg0.currentProt = null;
                                                                    return true;
                                                                } else if (ServerProt.UPDATE_RUNENERGY == arg0.currentProt) {
                                                                    Static703.anInt10571 = bitPacket.g1();
                                                                    arg0.currentProt = null;
                                                                    Static321.lastMiscTransmit = World.tick;
                                                                    return true;
                                                                } else if (arg0.currentProt == ServerProt.IF_SETANGLE) {
                                                                    local277 = bitPacket.g2_alt2();
                                                                    local100 = bitPacket.g2_alt3();
                                                                    local526 = bitPacket.g4_alt1();
                                                                    ...
                                                                    arg0.currentProt = null;
                                                                    return true;
                                                                } else if (ServerProt.CLIENT_SETVARCSTR_LARGE == arg0.currentProt) {
                                                                    local1937 = bitPacket.gjstr();
                                                                    local100 = bitPacket.g2_alt2();
                                                                    Static574.method7573();
                                                                    ...
                                                                    arg0.currentProt = null;
                                                                    return true;
                                                                } else if (arg0.currentProt == ServerProt.MESSAGE_PRIVATE) {
                                                                    local446 = bitPacket.g1() == 1;
                                                                    local627 = bitPacket.gjstr();
                                                                    local629 = local627;
                                                                    if (local446) {
                                                                    ...
                                                                    arg0.currentProt = null;
                                                                    return true;
                                                                } else if (arg0.currentProt == ServerProt.MIDI_SONG) {
                                                                    local277 = bitPacket.g1_alt3();
                                                                    local100 = bitPacket.ig2();
                                                                    if (local100 == 65535) {
                                                                        local100 = -1;
                                                                    ...
                                                                    arg0.currentProt = null;
                                                                    return true;
                                                                } else if (ServerProt.MIDI_JINGLE == arg0.currentProt) {
                                                                    local277 = bitPacket.g2_alt2();
                                                                    if (local277 == 65535) {
                                                                        local277 = -1;
                                                                    }
                                                                    ...
                                                                    arg0.currentProt = null;
                                                                    return true;
                                                                } else if (ServerProt.JAVASCRIPT_RUN == arg0.currentProt) {
                                                                    if (GameShell.fsframe != null) {
                                                                        InterfaceManager.changeWindowMode(ClientOptions.instance.screenSizeDefault.getValue(), -1, false, -1);
                                                                    }
                                                                    local3044 = new byte[arg0.currentPacketSize];
                                                                    ...
                                                                    arg0.currentProt = null;
                                                                    return true;
                                                                } else if (arg0.currentProt == ServerProt.DEBUG_SERVER_TRIGGERS) {
                                                                    local277 = bitPacket.g2();
                                                                    local100 = bitPacket.g2();
                                                                    local526 = bitPacket.g2();
                                                                    Static574.method7573();
                                                                    ...
                                                                    arg0.currentProt = null;
                                                                    return true;
                                                                } else if (arg0.currentProt == ServerProt.IF_SETPLAYERMODEL_OTHER) {
                                                                    local277 = bitPacket.g4_alt2();
                                                                    local100 = bitPacket.g2();
                                                                    local526 = bitPacket.g4_alt3();
                                                                    Static574.method7573();
                                                                    ...
                                                                    arg0.currentProt = null;
                                                                    return true;
                                                                } else if (arg0.currentProt == ServerProt.CAM_SMOOTH_RESET) {
                                                                    Static574.method7573();
                                                                    Camera.smoothReset();
                                                                    arg0.currentProt = null;
                                                                    return true;
                                                                } else if (arg0.currentProt == ServerProt.PLAYER_INFO) {
                                                                    PlayerList.iteratePlayers(bitPacket, arg0.currentPacketSize);
                                                                    arg0.currentProt = null;
                                                                    return true;
                                                                } else if (ServerProt.CHAT_FILTER_SETTINGS == arg0.currentProt) {
                                                                    Static133.anInt2458 = bitPacket.g1();
                                                                    Static87.anInt1806 = bitPacket.g1();
                                                                    arg0.currentProt = null;
                                                                    return true;
                                                                } else if (ServerProt.UPDATE_ZONE_FULL_FOLLOWS == arg0.currentProt) {
                                                                    ...
                                                                    arg0.currentProt = null;
                                                                    return true;
                                                                } else if (arg0.currentProt == ServerProt.IF_SETPLAYERHEAD) {
                                                                    local277 = bitPacket.g4_alt1();
                                                                    Static574.method7573();
                                                                    ...
                                                                    if (ServerProt.MESSAGE_PLAYER_GROUP == arg0.currentProt) {
                                                                        local446 = bitPacket.g1() == 1;
                                                                        local627 = bitPacket.gjstr();
                                                                        local629 = local627;
                                                                        if (local446) {
                                                                        ...
                                                                        arg0.currentProt = null;
                                                                        return true;
                                                                    } else if (ServerProt.LOGOUT_TRANSFER == arg0.currentProt) {
                                                                        local277 = bitPacket.g2();
                                                                        local627 = bitPacket.gjstr();
                                                                        ...
                                                                        arg0.currentProt = null;
                                                                        return false;
                                                                    } else if (arg0.currentProt == ServerProt.TRIGGER_ONDIALOGABORT) {
                                                                        if (InterfaceManager.topLevelInterface != -1) {
                                                                            InterfaceManager.runHookImmediate(InterfaceManager.IMMEDIATE_HOOK_TYPE_DIALOGABORT, InterfaceManager.topLevelInterface);
                                                                        }
                                                                        arg0.currentProt = null;
                                                                        return true;
                                                                    } else if (arg0.currentProt == ServerProt.FRIENDLIST_LOADED) {
                                                                        Static251.anInt4036 = 1;
                                                                        Static344.lastFriendTransmit = World.tick;
                                                                        arg0.currentProt = null;
                                                                        return true;
                                                                    } else if (arg0.currentProt == ServerProt.CLANCHANNEL_FULL) {
                                                                        Static39.lastClanChannelTransmit = World.tick;
                                                                        local446 = bitPacket.g1() == 1;
                                                                        if (arg0.currentPacketSize != 1) {
                                                                            if (local446) {
                                                                        ...
                                                                        arg0.currentProt = null;
                                                                        return true;
                                                                    } else if (ServerProt.UPDATE_ZONE_PARTIAL_ENCLOSED == arg0.currentProt) {
                                                                        ...
                                                                        arg0.currentProt = null;
                                                                        return true;
                                                                    } else if (ServerProt.REBUILD_NORMAL == arg0.currentProt) {
                                                                        Static434.rebuildNormal();
                                                                        arg0.currentProt = null;
                                                                        return false;
                                                                    } else if (arg0.currentProt == ServerProt.LOC_ANIM_SPECIFIC) {
                                                                        local277 = bitPacket.g4_alt3();
                                                                        ...
                                                                        arg0.currentProt = null;
                                                                        return true;
                                                                    } else if (ServerProt.IGNORELIST_ADD == arg0.currentProt) {
                                                                        local277 = bitPacket.g1();
                                                                        ...
                                                                        arg0.currentProt = null;
                                                                        return true;
                                                                    } else if (ServerProt.JCOINS_UPDATE == arg0.currentProt) {
                                                                        local277 = bitPacket.g4_alt2();
                                                                        ...
                                                                        arg0.currentProt = null;
                                                                        return true;
                                                                    } else if (ServerProt.MESSAGE_QUICKCHAT_PLAYER_GROUP == arg0.currentProt) {
                                                                        local446 = bitPacket.g1() == 1;
                                                                        local627 = bitPacket.gjstr();
                                                                        local629 = local627;
                                                                        if (local446) {
                                                                        ...
                                                                        if (arg0.currentProt == ServerProt.UPDATE_FRIENDCHAT_CHANNEL_SINGLEUSER) {
                                                                            local1937 = bitPacket.gjstr();
                                                                            local2080 = bitPacket.g1() == 1;
                                                                            if (local2080) {
                                                                                local627 = bitPacket.gjstr();
                                                                            ...
                                                                            arg0.currentProt = null;
                                                                            return true;
                                                                        } else if (arg0.currentProt == ServerProt.VARCLAN_INT) {
                                                                            local277 = bitPacket.g2();
                                                                            local100 = bitPacket.g4();
                                                                            if (Static279.anObjectArray35 == null) {
                                                                                Static279.anObjectArray35 = new Object[VarClanSettingTypeList.instance.num];
                                                                            ...
                                                                            arg0.currentProt = null;
                                                                            return true;
                                                                        } else if (ServerProt.MESSAGE_PUBLIC == arg0.currentProt) {
                                                                            local277 = bitPacket.g2();
                                                                            ...
                                                                            arg0.currentProt = null;
                                                                            return true;
                                                                        } else if (arg0.currentProt == ServerProt.SYNTH_SOUND) {
                                                                            local277 = bitPacket.g2();
                                                                            if (local277 == 65535) {
                                                                                local277 = -1;
                                                                            }
                                                                            ...
                                                                            arg0.currentProt = null;
                                                                            return true;
                                                                        } else if (ServerProt.SERVER_TICK_END == arg0.currentProt) {
                                                                            arg0.currentProt = null;
                                                                            return false;
                                                                        } else if (ServerProt.IF_SETEVENTS == arg0.currentProt) {
                                                                            local277 = bitPacket.ig2();
                                                                            if (local277 == 65535) {
                                                                                local277 = -1;
                                                                            }
                                                                            ...
                                                                            arg0.currentProt = null;
                                                                            return true;
                                                                        } else if (arg0.currentProt == ServerProt.IF_SETRETEX) {
                                                                            local277 = bitPacket.g2();
                                                                            local100 = bitPacket.g4();
                                                                            local526 = bitPacket.g2();
                                                                            local1409 = bitPacket.g1_alt3();
                                                                            ...
                                                                            arg0.currentProt = null;
                                                                            return true;
                                                                        } else if (arg0.currentProt == ServerProt.UPDATE_ZONE_PARTIAL_FOLLOWS) {
                                                                            ...
                                                                            arg0.currentProt = null;
                                                                            return true;
                                                                        } else if (ServerProt.CAM_FORCEANGLE == arg0.currentProt) {
                                                                            local277 = bitPacket.g2_alt3();
                                                                            local100 = bitPacket.g2_alt2();
                                                                            Static574.method7573();
                                                                            ...
                                                                            arg0.currentProt = null;
                                                                            return true;
                                                                        } else if (ServerProt.UPDATE_DOB == arg0.currentProt) {
                                                                            Static106.lobbyMembersStats = bitPacket.g3s();
                                                                            Static389.underage = bitPacket.g1() == 1;
                                                                            arg0.currentProt = null;
                                                                            return true;
                                                                        } else if (arg0.currentProt == ServerProt.CLIENT_SETVARC_SMALL) {
                                                                            local277 = bitPacket.g2_alt3();
                                                                            local931 = bitPacket.g1b_alt3();
                                                                            Static574.method7573();
                                                                            ...
                                                                            arg0.currentProt = null;
                                                                            return true;
                                                                        } else if (arg0.currentProt == ServerProt.CLANSETTINGS_DELTA) {
                                                                            Static400.lastClanSettingsTransmit = World.tick;
                                                                            local446 = bitPacket.g1() == 1;
                                                                            ...
                                                                            arg0.currentProt = null;
                                                                            return true;
                                                                        } else if (arg0.currentProt == ServerProt.IF_SETTEXT) {
                                                                            local277 = bitPacket.g4();
                                                                            local627 = bitPacket.gjstr();
                                                                            Static574.method7573();
                                                                            ...
                                                                            arg0.currentProt = null;
                                                                            return true;
                                                                        } else if (arg0.currentProt == ServerProt.UPDATE_INV_STOP_TRANSMIT) {
                                                                            local277 = bitPacket.ig2();
                                                                            ...
                                                                            arg0.currentProt = null;
                                                                            return true;
                                                                        } else if (arg0.currentProt == ServerProt.UPDATE_FRIENDCHAT_CHANNEL_FULL) {
                                                                            Static352.lastClanTransmit = World.tick;
                                                                            if (arg0.currentPacketSize == 0) {
                                                                                arg0.currentProt = null;
                                                                                FriendChat.count = 0;
                                                                            ...
                                                                            return true;
                                                                        } else if (ServerProt.MAP_PROJANIM == arg0.currentProt) {
                                                                            method7912(ZoneProt.MAP_PROJANIM);
                                                                            arg0.currentProt = null;
                                                                            return true;
                                                                        } else if (arg0.currentProt == ServerProt.SET_MAP_FLAG) {
                                                                            local277 = bitPacket.g1();
                                                                            local100 = bitPacket.g1_alt1();
                                                                            if (local277 == 255) {
                                                                                local100 = -1;
                                                                            ...
                                                                            arg0.currentProt = null;
                                                                            return true;
                                                                        } else if (arg0.currentProt == ServerProt.MESSAGE_FRIENDCHANNEL) {
                                                                            local446 = bitPacket.g1() == 1;
                                                                            local627 = bitPacket.gjstr();
                                                                            local629 = local627;
                                                                            if (local446) {
