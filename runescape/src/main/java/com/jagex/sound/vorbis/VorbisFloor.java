...
public final class VorbisFloor {
    ...
    private static final float[] inverse_dB_table = {
    ...
    public VorbisFloor() {
        ...
        this.x_list = new int[values];
        this.x_list[0] = 0;
        this.x_list[1] = 0x1 << rangebits;
        ...
        for (@Pc(168) int i = 0; i < partitionCount; i++) {
            ...
            for (@Pc(176) int j = 0; j < this.classDimensions[partitionClass]; j++) {
                this.x_list[values++] = VorbisSound.gbit(rangebits);
            }
        }
    ...
    public void computeCurve(@OriginalArg(0) float[] v, @OriginalArg(1) int n) {
        ...
        @Pc(3) int values = this.x_list.length;
        ...
        @Pc(201) float scale = inverse_dB_table[ly];
    ...
    public boolean decode() {
        ...
        @Pc(15) int values = this.x_list.length;
        for (@Pc(17) int i = 0; i < values; i++) {
            X_list[i] = this.x_list[i];
        }
