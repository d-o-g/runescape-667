...
public final class Class218 {
    ...
    public void method5125(@OriginalArg(0) int arg0, @OriginalArg(1) Node_Sub21 arg1) {
        if (arg0 == 1) {
            ...
            this.aString54 = arg1.method7343();
        } else {
            @Pc(29) int local29;
            @Pc(36) int local36;
            if (arg0 == 3) {
                ...
                for (local36 = 0; local36 < local29; local36++) {
                    this.anIntArrayArray138[local36][0] = arg1.method7382();
                ...
                for (local36 = 0; local36 < local29; local36++) {
                    this.anIntArrayArray137[local36][0] = arg1.method7382();
                ...
                if (arg0 == 9) {
                    ...
                    for (local36 = 0; local36 < local29; local36++) {
                        this.anIntArray435[local36] = arg1.method7382();
                    }
                } else if (arg0 == 14) {
                    local29 = arg1.method7396();
                    this.anIntArrayArray139 = new int[local29][2];
                    for (local36 = 0; local36 < local29; local36++) {
                        this.anIntArrayArray139[local36][0] = arg1.method7396();
                        this.anIntArrayArray139[local36][1] = arg1.method7396();
                    }
                } else if (arg0 == 15) {
                    arg1.method7382();
                } else if (arg0 == 17) {
                    this.anInt5704 = arg1.method7382();
                } else if (arg0 == 18) {
                    local29 = arg1.method7396();
                    ...
                    for (local36 = 0; local36 < local29; local36++) {
                        ...
                        this.aStringArray28[local36] = arg1.method7358();
                    }
                } else if (arg0 == 19) {
                    local29 = arg1.method7396();
                    ...
                    for (local36 = 0; local36 < local29; local36++) {
                        ...
                        this.aStringArray27[local36] = arg1.method7358();
                    }
                } else if (arg0 == 249) {
                    local29 = arg1.method7396();
