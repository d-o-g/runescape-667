...
public final class Static339 {
    ...
    public static int getWaterBias(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
    ...
    public static void method5007(@OriginalArg(0) int arg0, @OriginalArg(1) byte[][][] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Toolkit arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) int arg10, @OriginalArg(12) int arg11) {
        if (arg11 == 0 || arg4 == 0) {
            return;
        }
        if (arg11 == 9) {
