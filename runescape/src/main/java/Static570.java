...
public final class Static570 {
    ...
    public static void method7549(@OriginalArg(1) Toolkit arg0) {
        ...
        for (@Pc(14) int local14 = 0; local14 < Static552.anIntArray753.length; local14++) {
            ...
            @Pc(24) Class381 local24 = Static238.method3468(local19, Static237.aJs5_87);
            @Pc(32) Class14 local32 = arg0.method8010(local24, Static735.method9387(Static555.aJs5_106, local19), true);
