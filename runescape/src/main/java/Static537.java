...
public final class Static537 {
    ...
    public static Node_Sub2_Sub10 method7189(@OriginalArg(0) Class242 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
        @Pc(10) int local10 = arg0.anInt6197 | arg1 << 10;
        @Pc(19) Node_Sub2_Sub10 local19 = (Node_Sub2_Sub10) Static480.aClass361_2.method8342((long) local10 << 16);
        if (local19 != null) {
            return local19;
        }
        ...
        if (local32 == null) {
            ...
            local19 = (Node_Sub2_Sub10) Static480.aClass361_2.method8342((long) local10 << 16);
            if (local19 != null) {
                return local19;
            }
