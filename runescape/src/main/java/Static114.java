...
public final class Static114 {
    ...
    public static void method2132(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) long arg2, @OriginalArg(4) ClippingMask arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Component arg7) {
        ...
        if (local16 <= local37 * local37) {
            Static6.method107(arg5, arg3, Sprites.hintMapmarkers[arg4], arg6, arg0, arg7, arg1);
            return;
        }
        local37 -= 10;
        @Pc(64) int local64;
        ...
        Sprites.hintMapedge[arg4].method8186((float) local136 + (float) arg7.width / 2.0F + (float) arg1, (float) -local143 + (float) arg7.height / 2.0F + (float) arg5, 4096, (int) (-local129 / 6.283185307179586D * 65535.0D));
    }
