...
public final class Static642 {
    ...
    public static Class8_Sub7 method8441(@OriginalArg(0) boolean arg0, @OriginalArg(2) int arg1) {
        @Pc(7) EntityList[] local7 = Class43.A_ENTITY_LIST_ARRAY_1;
        synchronized (Class43.A_ENTITY_LIST_ARRAY_1) {
            @Pc(37) Class8_Sub7 local37;
            if (Class43.A_ENTITY_LIST_ARRAY_1.length <= arg1 || Class43.A_ENTITY_LIST_ARRAY_1[arg1].method2782()) {
                ...
                local37 = (Class8_Sub7) Class43.A_ENTITY_LIST_ARRAY_1[arg1].method2788();
                local37.method9274();
