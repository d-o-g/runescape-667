...
public final class Class303 implements TextureSource {
    ...
    public Class303(@OriginalArg(0) js5 arg0, @OriginalArg(1) js5 arg1, @OriginalArg(2) js5 arg2) {
        ...
        for (@Pc(36) int local36 = 0; local36 < this.anInt7709; local36++) {
            if (local24.g1() == 1) {
                this.aTextureMetricsArray1[local36] = new TextureMetrics();
            }
        }
        for (@Pc(65) int local65 = 0; local65 < this.anInt7709; local65++) {
            if (this.aTextureMetricsArray1[local65] != null) {
                this.aTextureMetricsArray1[local65].aBoolean240 = local24.g1() == 0;
            }
        }
        ...
        for (@Pc(132) int local132 = 0; local132 < this.anInt7709; local132++) {
            if (this.aTextureMetricsArray1[local132] != null) {
                this.aTextureMetricsArray1[local132].aBoolean234 = local24.g1() == 1;
            }
        }
        for (@Pc(168) int local168 = 0; local168 < this.anInt7709; local168++) {
            if (this.aTextureMetricsArray1[local168] != null) {
                this.aTextureMetricsArray1[local168].aByte57 = local24.g1b();
            }
        }
        ...
        for (@Pc(288) int local288 = 0; local288 < this.anInt7709; local288++) {
            if (this.aTextureMetricsArray1[local288] != null) {
                this.aTextureMetricsArray1[local288].aShort37 = (short) local24.g2();
            }
        }
        ...
        for (@Pc(381) int local381 = 0; local381 < this.anInt7709; local381++) {
            if (this.aTextureMetricsArray1[local381] != null) {
                this.aTextureMetricsArray1[local381].aBoolean239 = local24.g1() == 1;
            }
        }
        for (@Pc(421) int local421 = 0; local421 < this.anInt7709; local421++) {
            if (this.aTextureMetricsArray1[local421] != null) {
                this.aTextureMetricsArray1[local421].aBoolean238 = local24.g1() == 1;
            }
        }
        for (@Pc(455) int local455 = 0; local455 < this.anInt7709; local455++) {
            if (this.aTextureMetricsArray1[local455] != null) {
                this.aTextureMetricsArray1[local455].aByte53 = local24.g1b();
            }
        }
        for (@Pc(483) int local483 = 0; local483 < this.anInt7709; local483++) {
            if (this.aTextureMetricsArray1[local483] != null) {
                this.aTextureMetricsArray1[local483].aBoolean236 = local24.g1() == 1;
            }
        }
        for (@Pc(521) int local521 = 0; local521 < this.anInt7709; local521++) {
            if (this.aTextureMetricsArray1[local521] != null) {
                this.aTextureMetricsArray1[local521].aBoolean235 = local24.g1() == 1;
            }
        }
        for (@Pc(559) int local559 = 0; local559 < this.anInt7709; local559++) {
            if (this.aTextureMetricsArray1[local559] != null) {
                this.aTextureMetricsArray1[local559].aBoolean237 = local24.g1() == 1;
            }
        }
    ...
    public DoublyLinkedNode_Sub2_Sub21 method6819(@OriginalArg(0) int arg0) {
        @Pc(10) Node2 local10 = this.aLinkedHashTable_3.get(arg0);
        if (local10 != null) {
        ...
        if (local30 == null) {
            ...
            this.aLinkedHashTable_3.put(local43, arg0);
            return local43;
        }
    }
    ...
    public int[] rgbOutput(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) float arg4) {
        return this.method6819(arg3).method8951(this.aJs5_99, arg4, this.aTextureMetricsArray1[arg3].aBoolean238, this, arg1, arg2, arg0);
    }
    ...
    public TextureMetrics getMetrics(@OriginalArg(0) int arg0) {
        return this.aTextureMetricsArray1[arg0];
    }
    ...
    public int[] argbOutput(@OriginalArg(0) float arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(5) int arg3) {
        return this.method6819(arg1).method8948(arg2, arg0, this.aTextureMetricsArray1[arg1].aBoolean238, arg3, this, this.aJs5_99);
    }
}
