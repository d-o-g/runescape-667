...
public class Animator_Sub2 extends Animator {
    ...
    public final Renderable aRenderable_24;

    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(Lclient!eo;Z)V")
    public Animator_Sub2(@OriginalArg(0) Renderable arg0, @OriginalArg(1) boolean arg1) {
        super(arg1);
        this.aRenderable_24 = arg0;
    }
    ...
    protected final void newFrame(@OriginalArg(0) int arg0, @OriginalArg(1) SeqType arg1) {
        Static431.method5827(arg1, arg0, this.aRenderable_24);
    }
}
