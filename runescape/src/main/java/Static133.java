...
public final class Static133 {
    ...
    public static void method2316() {
        ...
        ClientOptions.instance.update(2, ClientOptions.instance.aClass57_Sub4_1);
        ClientOptions.instance.update(2, ClientOptions.instance.aClass57_Sub4_2);
        ...
        ClientOptions.instance.update(1, ClientOptions.instance.aClass57_Sub27_1);
        ClientOptions.instance.update(1, ClientOptions.instance.aClass57_Sub8_1);
        ClientOptions.instance.update(1, ClientOptions.instance.aClass57_Sub7_1);
        ...
        ClientOptions.instance.update(1, ClientOptions.instance.aClass57_Sub16_1);
        ...
        ClientOptions.instance.update(1, ClientOptions.instance.aClass57_Sub28_1);
        ...
        ClientOptions.instance.update(1, ClientOptions.instance.aClass57_Sub18_1);
        ClientOptions.instance.update(3, ClientOptions.instance.aClass57_Sub15_1);
