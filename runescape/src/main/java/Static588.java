...
public final class Static588 {
    ...
    public static void method7713() {
        Static425.aToolkit_13.xa(((float) Static400.aClass2_Sub34_28.aClass57_Sub22_1.method6769() * 0.1F + 0.7F) * Static318.aFloat210);
        Static425.aToolkit_13.ZA(Static448.anInt6801, Static688.aFloat216, Static683.aFloat215, (float) (Static344.anInt5617 << 2), (float) (Static417.anInt6400 << 2), (float) (Static331.anInt5441 << 2));
        Static425.aToolkit_13.method7973(Static425.aClass67_6);
    }
    ...
    public static boolean method7714(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
        if (!Static18.aBoolean20 || !Static29.aBoolean60) {
            ...
            if (-Static675.anInt10155 == local37) {
                ...
                return true;
            } else if (Static693.aGroundArray2 == Static246.aGroundArray1) {
                return false;
            } else {
                @Pc(64) int local64 = arg2 << Static52.anInt1066;
                @Pc(68) int local68 = arg0 << Static52.anInt1066;
                if (Static172.method2674(local64 + Static340.anInt5586 - 1, local68 + 1, Static246.aGroundArray1[arg1].method7869(arg0 + 1, arg2 + 1), Static246.aGroundArray1[arg1].method7869(arg0 + 1, arg2), Static246.aGroundArray1[arg1].method7869(arg0, arg2), local68 + Static340.anInt5586 - 1, Static340.anInt5586 + local68 + -1, local64 + 1, local64 + 1) && Static172.method2674(Static340.anInt5586 + local64 - 1, local68 + 1, Static246.aGroundArray1[arg1].method7869(arg0, arg2 + 1), Static246.aGroundArray1[arg1].method7869(arg0 + 1, arg2 + 1), Static246.aGroundArray1[arg1].method7869(arg0, arg2), local68 + 1, Static340.anInt5586 + local68 + -1, local64 + 1, Static340.anInt5586 + -1 + local64)) {
                    Static298.anInt4811++;
