...
public final class Class398 {
    ...
    public Interface13 method9168(@OriginalArg(1) Interface10 arg0) {
        ...
        if (local18 == Static515.aClass204_10) {
            ...
            return new Class37(this.aJs5_125, (Class160) arg0);
        } else if (Static647.aClass204_13 == local18) {
            return new Class37_Sub1(this.aJs5_125, (Class160_Sub1) arg0);
        } else if (Static77.aClass204_1 == local18) {
            return new Class90_Sub1(this.aJs5_125, this.aJs5_124, (Class138_Sub3) arg0);
        } else if (Static565.aClass204_9 == local18) {
            return new Class90_Sub3(this.aJs5_125, this.aJs5_124, (Class138_Sub2) arg0);
        } else if (Static535.aClass204_11 == local18) {
            return new Class90_Sub2(this.aJs5_125, this.aJs5_124, (Class138_Sub1) arg0);
        } else if (local18 == Static189.aClass204_7) {
            return new Class133(this.aJs5_125, this.aJs5_124, (Class125) arg0);
        } else if (local18 == Static667.aClass204_15) {
            return new Class109(this.aJs5_125, (Class200) arg0);
        } else if (Static505.aClass204_16 == local18) {
            return new Class90_Sub2_Sub1(this.aJs5_125, this.aJs5_124, (Class138_Sub1_Sub1) arg0);
        } else {
            return null;
        }
    }
