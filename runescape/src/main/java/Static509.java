...
public final class Static509 {
    ...
    public static void method6759(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
        ...
        if (!WorldMap.hovered || Static551.aDeque_54 == null) {
            return;
        }
        for (@Pc(197) Node_Sub37 local197 = (Node_Sub37) Static551.aDeque_54.first(); local197 != null; local197 = (Node_Sub37) Static551.aDeque_54.next()) {
            ...
            if (local197.method5553(arg0, arg1)) {
                if (local206.aStringArray9 != null) {
                    if (local206.aStringArray9[4] != null) {
                        MiniMenu.addEntry(false, -1, (long) local197.aClass2_Sub20_1.anInt3131, local206.anInt2597, 0, local206.aStringArray9[4], 1004, true, -1, local206.aString24, (long) local197.aClass2_Sub20_1.anInt3131, false);
                    }
                    if (local206.aStringArray9[3] != null) {
                        MiniMenu.addEntry(false, -1, (long) local197.aClass2_Sub20_1.anInt3131, local206.anInt2597, 0, local206.aStringArray9[3], 1009, true, -1, local206.aString24, (long) local197.aClass2_Sub20_1.anInt3131, false);
                    }
                    if (local206.aStringArray9[2] != null) {
                        MiniMenu.addEntry(false, -1, (long) local197.aClass2_Sub20_1.anInt3131, local206.anInt2597, 0, local206.aStringArray9[2], 1006, true, -1, local206.aString24, (long) local197.aClass2_Sub20_1.anInt3131, false);
                    }
                    if (local206.aStringArray9[1] != null) {
                        MiniMenu.addEntry(false, -1, (long) local197.aClass2_Sub20_1.anInt3131, local206.anInt2597, 0, local206.aStringArray9[1], 1001, true, -1, local206.aString24, (long) local197.aClass2_Sub20_1.anInt3131, false);
                    }
                    if (local206.aStringArray9[0] != null) {
                        MiniMenu.addEntry(false, -1, (long) local197.aClass2_Sub20_1.anInt3131, local206.anInt2597, 0, local206.aStringArray9[0], 1003, true, -1, local206.aString24, (long) local197.aClass2_Sub20_1.anInt3131, false);
                    }
                }
