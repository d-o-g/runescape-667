...
public abstract class Class14 {
    ...
    public final int method8816(@OriginalArg(0) Sprite[] arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(5) String arg3, @OriginalArg(6) int[] arg4, @OriginalArg(8) Random arg5, @OriginalArg(9) int arg6) {
        if (arg3 == null) {
            return 0;
        }
        ...
        for (@Pc(29) int local29 = 0; local29 < local20; local29++) {
            ...
            if (local40 == '<') {
                ...
                if (local13 == -1) {
                    ...
                    if (local40 != ' ') {
                        if ((anInt1536 & 0xFF000000) != 0) {
                            this.fa(local40, arg4 + local268 + 1, local164 + (local7 - -1), anInt1536, true);
                        }
                        this.fa(local40, arg4 + local268, local164 + local7, anInt9801, false);
                    } else if (anInt922 > 0) {
                        anInt3187 += anInt922;
                        arg4 += anInt3187 >> 8;
                        anInt3187 &= 0xFF;
    ...
    public void method8822(@OriginalArg(1) int arg0, @OriginalArg(2) String arg1) {
        @Pc(5) int local5 = 0;
            ...
            if (local33 == '<') {
                ...
                if (local11 == -1) {
                    ...
                    if (local33 == ' ') {
                        ...
                        if ((anInt1536 & 0xFF000000) != 0) {
                            this.fa(local33, arg4 + 1, local5 - -1, anInt1536, true);
                        }
                        this.fa(local33, arg4, local5, anInt9801, false);
                    } else {
                        if ((anInt1536 & 0xFF000000) != 0) {
                            this.method8817(local33, arg4 + 1, local5 - -1, anInt1536, true, arg5, arg2, arg1);
                        }
    ...
    public void method8825(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
        anInt922 = 0;
        anInt9767 = arg0;
        anInt9801 = arg0;
        anInt3187 = 0;
    ...
    public final int method8830(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Sprite[] arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) ClippingMask arg9, @OriginalArg(11) int arg10, @OriginalArg(12) int arg11, @OriginalArg(13) int arg12, @OriginalArg(14) int arg13, @OriginalArg(15) int[] arg14, @OriginalArg(16) String arg15) {
        ...
        for (local233 = 0; local233 < local93; local233++) {
            if (arg13 == 0) {
                ...
                this.method8822(arg11, aStringArray2[local233]);
                this.method8824(arg3, arg5, arg8, aStringArray2[local233], arg12, arg9, local190, arg14);
                anInt922 = 0;
            }
            local190 += arg10;
    ...
    public void method8831(@OriginalArg(1) String arg0) {
        try {
            ...
            if (arg0.startsWith("argb=")) {
                ...
                this.method8825(anInt9767, anInt9766);
            }
    ...
    public final int method8836(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int[] arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Random arg6, @OriginalArg(8) String arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) Sprite[] arg10, @OriginalArg(12) int arg11, @OriginalArg(13) int arg12, @OriginalArg(14) int arg13) {
        if (arg7 == null) {
            return 0;
        }
