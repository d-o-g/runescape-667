...
public final class Ground_Sub3 extends Ground {
    ...
    public void method7161(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class399 arg3, @OriginalArg(4) Class219 arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int arg9) {
    ...
    public void U(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) boolean arg13) {
        ...
        if (local9) {
            ...
            for (local205 = 0; local205 < local147.aShort110; local205++) {
                ...
                if (arg6[local205] == 0) {
                    ...
                    local530 = -16777216;
                    if (arg8[local205] != -1 && this.method7162(this.aClass19_Sub2_8.textureSource.method6817(arg8[local205]).aByte56)) {
                        local530 = -1694498816;
                    }
        ...
        if (!local654) {
            ...
            for (local530 = 0; local530 < local1760.aShort129; local530++) {
                if (arg8[local530 * 3] != -1 && !this.aClass19_Sub2_8.textureSource.method6817(arg8[local530 * 3]).aBoolean240) {
                    local2164 = true;
                }
            }
            if (arg7 != null) {
            ...
            for (local1834 = 0; local1834 < local1760.aShort129; local1834++) {
                ...
                if (local2164) {
                    ...
                    if (local2264 == -1 || this.aClass19_Sub2_8.textureSource.method6817(local2264).aBoolean240) {
                        local2260 = false;
                    } else {
                        local2258 = true;
                    }
                    ...
                    if (local2260) {
                        ...
                        if (local2258) {
                            ...
                            if (local2264 != -1 && !this.aClass19_Sub2_8.textureSource.method6817(local2264).aBoolean240) {
                                local1760.anIntArray802[local1961] = Static323.anIntArray389[Static105.method2043(this.aClass19_Sub2_8.textureSource.method6817(local2264).aShort37 & 0xFFFF) & 0xFFFF];
                            }
                            local2264 = arg8[local2008];
                            if (local2264 != -1 && !this.aClass19_Sub2_8.textureSource.method6817(local2264).aBoolean240) {
                                local1760.anIntArray802[local2008] = Static323.anIntArray389[Static105.method2043(this.aClass19_Sub2_8.textureSource.method6817(local2264).aShort37 & 0xFFFF) & 0xFFFF];
                            }
                            local2264 = arg8[local2098];
                            if (local2264 != -1 && !this.aClass19_Sub2_8.textureSource.method6817(local2264).aBoolean240) {
                                local1760.anIntArray802[local2098] = Static323.anIntArray389[Static105.method2043(this.aClass19_Sub2_8.textureSource.method6817(local2264).aShort37 & 0xFFFF) & 0xFFFF];
                            }
                        }
        ...
        if (local498 == -1 || (local931.aByte126 & 0x2) != 0 || this.aClass19_Sub2_8.textureSource.method6817(local498).aBoolean240) {
    ...
    public void method7163(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4, @OriginalArg(8) Class399 arg5, @OriginalArg(9) Class219 arg6, @OriginalArg(10) int[] arg7, @OriginalArg(11) int[] arg8) {
    ...
    public void method7164(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4, @OriginalArg(8) Class399 arg5, @OriginalArg(9) Class219 arg6, @OriginalArg(10) int[] arg7, @OriginalArg(11) int[] arg8) {
        @Pc(7) int local7 = (arg3 - arg1) * 1024 / 256;
        @Pc(14) boolean local14 = arg5.aBoolean804;
        this.aClass19_Sub2_8.C(false);
        arg6.aBoolean436 = false;
    ...
    public void method7165(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class219 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int arg7) {
    ...
    public void method7871(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int[] arg10, @OriginalArg(11) int[] arg11, @OriginalArg(12) int[] arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15) {
        ...
        if (!local33) {
            ...
            for (local323 = 0; local323 < local126; local323++) {
                ...
                if (local370 != -1) {
                    @Pc(490) Class118 local490 = this.aClass19_Sub2_8.textureSource.method6817(local370);
            ...
            for (local370 = 0; local370 < local126; local370++) {
                if (arg9[local370] >= 0 || arg10 != null && arg10[local370] >= 0) {
                    ...
                    if (local454) {
                        if (arg11[local370] == -1 || this.aClass19_Sub2_8.textureSource.method6817(arg11[local370]).aBoolean240) {
            ...
            if (local85 != -1) {
                local849 = this.aClass19_Sub2_8.textureSource.method6817(local85);
            }
    ...
    public void method7166(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class399 arg3, @OriginalArg(4) Class219 arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int arg9) {
        ...
        if (local6 == null) {
                        ...
                        for (local559 = 0; local559 < local3142.aShort129; local559++) {
                            ...
                            if ((local589 - local3620) * (local3636 - local3632) - (local3628 - local3632) * (local3624 - local3620) > 0) {
                                ...
                                if (local3648 >= 765) {
                                    ...
                                    if (local3705 != -1) {
                                        local3719 = -16777216;
                                        if (local3705 != -1 && this.method7162(this.aClass19_Sub2_8.textureSource.method6817(local3705).aByte56)) {
            ...
            @Pc(1864) boolean local1864 = local6.aShort105 != -1 && this.method7162(this.aClass19_Sub2_8.textureSource.method6817(local6.aShort105).aByte56);
            if (this.anInt8145 == -1) {
