...
public final class DoublyLinkedNode_Sub2_Sub4 extends DoublyLinkedNode {
    ...
    public int method1468() {
        return this.aQueue_3.tail.next2 == this.aQueue_3.tail ? -1 : ((DoublyLinkedNode_Sub2_Sub16) this.aQueue_3.tail.next2).anInt7314;
    }
