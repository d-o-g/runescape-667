...
public abstract class Class35 {
    ...
    public int anInt6503 = 4;

    @OriginalMember(owner = "client!lea", name = "a", descriptor = "[S")
    public final short[] aShortArray98 = new short[512];
            ...
            for (@Pc(77) int local77 = 0; local77 < 128; local77++) {
                for (@Pc(80) int local80 = 0; local80 < 128; local80++) {
                    for (@Pc(83) int local83 = 0; local83 < this.anInt6505; local83++) {
                        ...
                        local175 &= 0xFF;
                        @Pc(237) int local237 = Node_Sub2_Sub19.anIntArray768[local122];
                        @Pc(241) int local241 = Node_Sub2_Sub19.anIntArray768[local187];
                        @Pc(245) int local245 = Node_Sub2_Sub19.anIntArray768[local99];
