...
public final class Class51_Sub4 extends Class51 implements Interface18 {
    ...
    public final int anInt9865;

    @OriginalMember(owner = "client!va", name = "G", descriptor = "I")
    public final int anInt9869;

    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Lclient!tca;Lclient!eba;IIZ[FII)V")
    public Class51_Sub4(@OriginalArg(0) Toolkit_Sub1_Sub2 arg0, @OriginalArg(1) Class92 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) float[] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
    ...
    public Class51_Sub4(@OriginalArg(0) Toolkit_Sub1_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
    ...
    public Class51_Sub4(@OriginalArg(0) Toolkit_Sub1_Sub2 arg0, @OriginalArg(1) Class92 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) byte[] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
    ...
    public Class51_Sub4(@OriginalArg(0) Toolkit_Sub1_Sub2 arg0, @OriginalArg(1) Class92 arg1, @OriginalArg(2) Class397 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
    ...
    public void method9044(@OriginalArg(3) int[] arg0, @OriginalArg(5) int arg1, @OriginalArg(6) int arg2) {
        ...
        for (@Pc(34) int local34 = 0; local34 < arg2; local34++) {
            Arrays.copy(local12, (arg2 - local34 - 1) * this.anInt9865, arg0, arg1 * local34, arg1);
        }
    }
