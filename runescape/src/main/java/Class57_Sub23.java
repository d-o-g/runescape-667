...
public final class Class57_Sub23 extends Class57 {
    ...
    public Class57_Sub23(@OriginalArg(0) int arg0, @OriginalArg(1) ClientOptions arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!qia", name = "<init>", descriptor = "(Lclient!kv;)V")
    public Class57_Sub23(@OriginalArg(0) ClientOptions arg0) {
        super(arg0);
    }
    ...
    public int method8352(@OriginalArg(0) int arg0) {
        if (super.aClass2_Sub34_34.method5111()) {
            ...
            if (arg0 == 0) {
                ...
                if (super.aClass2_Sub34_34.textures.value() == 1) {
                    return 2;
                }
                if (super.aClass2_Sub34_34.waterDetail.value() > 0) {
                    return 2;
                }
            }
            return 1;
