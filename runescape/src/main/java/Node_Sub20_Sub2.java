...
public final class Node_Sub20_Sub2 extends Node_Sub10 {
    ...
    public void method6332(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Canvas arg2) {
        ...
        @Pc(57) WritableRaster local57 = Raster.createWritableRaster(local47.createCompatibleSampleModel(this.anInt7053, this.anInt7050), local39, null);
