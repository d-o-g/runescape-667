...
public final class Static360 {
    ...
    public static String method5233(@OriginalArg(1) int arg0) {
        ...
        if (local8.length() > 9) {
            return " <col=00ff80>" + local8.substring(0, local8.length() - 8) + Static32.A_LOCALISED_TEXT___33.localise(Static51.anInt1052) + " (" + local8 + ")</col>";
        } else if (local8.length() > 6) {
            return " <col=ffffff>" + local8.substring(0, local8.length() - 4) + Static32.A_LOCALISED_TEXT___35.localise(Static51.anInt1052) + " (" + local8 + ")</col>";
        } else {
