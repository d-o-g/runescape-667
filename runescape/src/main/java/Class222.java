...
public abstract class Class222 {
    ...
    public Node_Sub28_Sub4 aClass2_Sub28_Sub4_2;
    ...
    public Node_Sub28_Sub1 aClass2_Sub28_Sub1_2;

    @OriginalMember(owner = "client!lf", name = "k", descriptor = "Lclient!mda;")
    public Node_Sub28_Sub3 aClass2_Sub28_Sub3_2;
    ...
    protected Class222(@OriginalArg(0) int arg0) {
        ...
        this.aIterableHashTable_45 = new IterableHashTable(8);
    }

    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(B)Lclient!kb;")
    public Node_Sub28 method9172() throws IOException {
        if (this.aBoolean800) {
            ...
            if (!this.anOggPage2.isBOS()) {
                @Pc(81) Node_Sub28 local81 = (Node_Sub28) this.aIterableHashTable_45.get((long) local25);
            ...
            if (!local99.pageIn(this.anOggPage2)) {
                ...
                this.aIterableHashTable_45.put((long) local25, local188);
                return local188;
            } else {
                throw new IllegalStateException();
            }
    ...
    public final void method9174(@OriginalArg(0) boolean arg0) {
        if (this.aClass2_Sub28_Sub1_2 != null) {
            @Pc(7) Node_Sub6_Sub5 local7 = this.aClass2_Sub28_Sub1_2.method3960();
            if (local7 != null) {
    ...
    public void method9175() throws IOException {
        while (this.aClass2_Sub28_Sub3_2.anOggStreamState5.packetOut(this.anOggPacket2) != 1) {
            @Pc(11) Node_Sub28 local11 = this.method9172();
            if (local11 == null) {
                if (this.aBoolean799) {
                    this.method9188();
                }
    ...
    public final Node_Sub28_Sub4 method9178() {
    ...
    public final void method9179() throws IOException {
        ...
        while (!this.aBoolean800) {
            ...
            if (this.aBoolean801) {
                local26 = (Node_Sub28) this.aIterableHashTable_45.get((long) this.anOggPage2.getSerialNumber());
            } else {
            ...
            if (local26 == this.aClass2_Sub28_Sub1_2) {
                ...
                while (local26.anOggStreamState5.packetOut(this.anOggPacket2) == 1) {
                    if (local26.anInt9753 == 1 && local26 instanceof Node_Sub28_Sub4) {
    ...
    public void method9180(@OriginalArg(0) byte arg0) {
        for (@Pc(11) Node_Sub28 local11 = (Node_Sub28) this.aIterableHashTable_45.first(); local11 != null; local11 = (Node_Sub28) this.aIterableHashTable_45.next()) {
    ...
    public final void method9181() {
        ...
        for (@Pc(14) Node_Sub28 local14 = (Node_Sub28) this.aIterableHashTable_45.first(); local14 != null; local14 = (Node_Sub28) this.aIterableHashTable_45.next()) {
            local14.method8560();
    ...
    public final void method9183(@OriginalArg(1) String arg0) {
        ...
        for (@Pc(50) Node_Sub28 local50 = (Node_Sub28) this.aIterableHashTable_45.first(); local50 != null; local50 = (Node_Sub28) this.aIterableHashTable_45.next()) {
    ...
    public final Node_Sub28_Sub3 method9187() {
        return this.aClass2_Sub28_Sub3_2;
    }

    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(B)V")
    public void method9188() {
        for (@Pc(7) Node_Sub28 local7 = (Node_Sub28) this.aIterableHashTable_45.first(); local7 != null; local7 = (Node_Sub28) this.aIterableHashTable_45.next()) {
    ...
    public final Node_Sub28_Sub1 method9189() {
