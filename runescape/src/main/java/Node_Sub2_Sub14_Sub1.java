...
public final class Node_Sub2_Sub14_Sub1 extends Node_Sub2_Sub14 {

    @OriginalMember(owner = "client!mh", name = "z", descriptor = "Ljava/lang/Object;")
    public final Object anObject11;

    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Ljava/lang/Object;I)V")
    public Node_Sub2_Sub14_Sub1(@OriginalArg(0) Object arg0, @OriginalArg(1) int arg1) {
        super(arg1);
