...
public abstract class Class8_Sub2_Sub1_Sub2 extends Class8_Sub2_Sub1 {
    ...
    public int method9299() {
        @Pc(17) Class289 local17 = this.method9317();
        @Pc(31) int local31;
    ...
    public final boolean method9307(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
        ...
        @Pc(43) Class289 local43 = this.method9317();
    ...
    public final Class289 method9317() {
        @Pc(13) int local13 = this.method9320(0);
        return local13 == -1 ? Static636.aClass289_1 : Static574.aClass310_2.method7118(local13);
    }
                ...
                if (local17 == 1) {
                    ...
                    for (local142 = 0; local142 < arg2.length; local142++) {
                        if (local29[local142] != null) {
                            Static734.method7691(local29[local142], 0, local138, local140, local29[local142].length);
                ...
                if (local21 == 1) {
                    ...
                    for (@Pc(199) int local199 = 0; local199 < arg2.length; local199++) {
                        if (local33[local199] != null) {
                            Static734.method7691(local33[local199], 0, local191, local142, local33[local199].length);
