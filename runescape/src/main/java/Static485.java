...
public final class Static485 {
    ...
    public static void method9415(@OriginalArg(0) Component arg0, @OriginalArg(2) Toolkit arg1) {
        @Pc(38) boolean local38 = Static419.objTypeList.getCachedSprite(arg0.objWearCol ? PlayerEntity.self.playerModel : null, arg1, arg0.objNumMode, arg0.invObject, arg0.outline, arg0.invCount, arg0.shadow | 0xFF000000) == null;
        if (local38) {
