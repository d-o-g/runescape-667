...
public final class Class318 {
    ...
    public void method7257(@OriginalArg(1) Node_Sub21 arg0, @OriginalArg(2) int arg1) {
        if (arg1 == 1) {
            ...
            this.anInt8255 = arg0.method7396();
        } else if (arg1 == 3) {
            this.anInt8255 = arg0.method7382();
            ...
            this.anInt8248 = Static579.method7633(arg0.method7383());
        } else if (arg1 == 8) {
            this.aClass96_5.anInt2509 = this.anInt8253;
        } else if (arg1 == 9) {
            this.anInt8250 = arg0.method7382() << 2;
        } else if (arg1 == 10) {
            this.aBoolean627 = false;
        } else if (arg1 == 11) {
            this.anInt8251 = arg0.method7396();
        } else if (arg1 == 12) {
            this.aBoolean628 = true;
        } else if (arg1 == 13) {
            this.anInt8260 = arg0.method7383();
        } else if (arg1 == 14) {
            this.anInt8252 = arg0.method7396() << 2;
        } else if (arg1 == 16) {
            this.anInt8256 = arg0.method7396();
        }
    }
}
