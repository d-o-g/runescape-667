...
public abstract class Class72 implements Interface21 {
    ...
    protected final GlxToolkit aClass19_Sub1_Sub2_11;

    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Lclient!tca;IZ)V")
    protected Class72(@OriginalArg(0) GlxToolkit arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
