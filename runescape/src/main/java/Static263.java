...
public final class Static263 {
    ...
    public static void method3856(@OriginalArg(0) PacketBuffer arg0) {
        arg0.method7417();
        @Pc(10) int local10 = 0;
        @Pc(20) int local20;
        @Pc(52) int local52;
        ...
        for (local144 = 0; local144 < Static51.anInt1053; local144++) {
            ...
            if ((Static402.aByteArray68[local243] & 0x1) == 0) {
                if (local10 > 0) {
                    ...
                    @Pc(351) int local351 = arg0.method7412(1);
                    if (local351 == 0) {
                        local10 = Static59.method5329(arg0);
                        Static402.aByteArray68[local243] = (byte) (Static402.aByteArray68[local243] | 0x2);
        ...
        for (local243 = 1; local243 < 2048; local243++) {
            ...
            @Pc(433) PlayerEntity local433 = PlayerList.highResolutionPlayers[local243];
            if (local433 == null) {
