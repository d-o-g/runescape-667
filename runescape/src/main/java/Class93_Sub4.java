...
public final class Class93_Sub4 extends Class93 {
    ...
    public final int anInt10926;

    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Lclient!qha;II[BI)V")
    public Class93_Sub4(@OriginalArg(0) Toolkit_Sub3 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte[] arg3, @OriginalArg(4) int arg4) {
