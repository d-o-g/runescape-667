...
public final class Class120_Sub2 extends Class120 implements MouseListener, MouseMotionListener {
    ...
    public void method8855(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
        ...
        local15.aLong181 = SystemTimer.safetime();
        this.aDeque_75.addLast(local15);
    }
    ...
    public int method8856(@OriginalArg(1) MouseEvent arg0) {
    ...
    public Node_Sub9 method8851() {
        return (Node_Sub9) this.aDeque_74.removeFirst();
    }
    ...
    public synchronized void method8841() {
        ...
        @Pc(18) Deque local18 = this.aDeque_74;
        this.aDeque_74 = this.aDeque_75;
        this.aDeque_75 = local18;
        this.aDeque_75.clear();
    }
}
