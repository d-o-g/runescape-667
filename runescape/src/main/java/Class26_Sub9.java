...
public final class Class26_Sub9 extends Class26 {
    ...
    public final D3DToolkit aClass19_Sub1_Sub1_7;
    ...
    public Class26_Sub9(@OriginalArg(0) D3DToolkit arg0, @OriginalArg(1) js5 arg1, @OriginalArg(2) Class7 arg2) {
        super(arg0);
        ...
        if (arg1 != null && this.aClass7_6.method116() && (this.aClass19_Sub1_Sub1_7.aD3DCAPS1.VertexShaderVersion & 0xFFFF) >= 257) {
            this.anIDirect3DVertexShader7 = this.aClass19_Sub1_Sub1_7.anIDirect3DDevice1.b(arg1.getfile("dx", "transparent_water"));
        } else {
    ...
    public void method8285() {
        if (this.anIDirect3DVertexShader7 != null) {
            ...
            @Pc(13) CompactMatrix local13 = this.aClass19_Sub1_Sub1_7.method8154();
    ...
    public void method8286() {
        this.aClass19_Sub1_Sub1_7.method4856(null);
        this.aClass19_Sub1_21.method8080(0, Static189.aClass168_2);
    ...
    public void method8296() {
        ...
        @Pc(16) IDirect3DDevice local16 = this.aClass19_Sub1_Sub1_7.anIDirect3DDevice1;
        @Pc(21) CompactMatrix local21 = this.aClass19_Sub1_21.method8066();
    ...
    public void method8288() {
        if (this.anIDirect3DVertexShader7 != null) {
            ...
            @Pc(11) CompactMatrix local11 = this.aClass19_Sub1_Sub1_7.method8154();
