...
public final class Static498 {
    ...
    public static void method6650(@OriginalArg(0) Renderable[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
        if (arg1 >= arg2) {
            return;
        }
        @Pc(8) int local8 = (arg1 + arg2) / 2;
        @Pc(10) int local10 = arg1;
        @Pc(14) Renderable local14 = arg0[local8];
        arg0[local8] = arg0[arg2];
        arg0[arg2] = local14;
        @Pc(27) int local27 = local14.anInt10697;
        for (@Pc(29) int local29 = arg1; local29 < arg2; local29++) {
            if (arg0[local29].anInt10697 > local27 + (local29 & 0x1)) {
                @Pc(44) Renderable local44 = arg0[local29];
