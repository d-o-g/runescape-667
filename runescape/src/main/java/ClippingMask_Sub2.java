...
public final class ClippingMask_Sub2 extends ClippingMask {
    ...
    public ClippingMask_Sub2(@OriginalArg(0) NativeToolkit arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte[] arg3) {
    ...
    public ClippingMask_Sub2(@OriginalArg(0) NativeToolkit arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3) {
