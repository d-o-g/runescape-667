...
public final class Static149 {
    ...
    public static void method2449(@OriginalArg(0) Toolkit arg0) {
        ...
        Static87.method1693(Static682.anInt10295, Static407.anInt6288, Static32.A_LOCALISED_TEXT___24.localise(Static51.anInt1052), arg0, local7 + Static84.anInt1775, Static71.anInt1576 - -local5);
        ...
        @Pc(89) int local89;
        @Pc(202) int local202;
        @Pc(281) DoublyLinkedNode_Sub2_Sub16 local281;
        @Pc(190) DoublyLinkedNode_Sub2_Sub16 local190;
        if (Static236.aBoolean304) {
            ...
            for (local77 = (DoublyLinkedNode_Sub2_Sub4) Static350.A_QUEUE___8.first(); local77 != null; local77 = (DoublyLinkedNode_Sub2_Sub4) Static350.A_QUEUE___8.next()) {
                ...
                if (local55 > local5 + Static71.anInt1576 && local55 < local5 + Static71.anInt1576 + Static682.anInt10295 && local66 > local89 - 13 && local66 < local89 + 4 && (local77.anInt1534 > 1 || ((DoublyLinkedNode_Sub2_Sub16) local77.aQueue_3.tail.next2).aBoolean552)) {
            ...
            if (Static139.aClass2_Sub2_Sub4_1 != null) {
                ...
                local70 = 0;
                for (local190 = (DoublyLinkedNode_Sub2_Sub16) Static139.aClass2_Sub2_Sub4_1.aQueue_3.first(); local190 != null; local190 = (DoublyLinkedNode_Sub2_Sub16) Static139.aClass2_Sub2_Sub4_1.aQueue_3.next()) {
            ...
            local70 = 0;
            for (local281 = (DoublyLinkedNode_Sub2_Sub16) Static693.A_DEQUE___79.first(65280); local281 != null; local281 = (DoublyLinkedNode_Sub2_Sub16) Static693.A_DEQUE___79.next()) {
        ...
        if (Static236.aBoolean304) {
            ...
            for (local77 = (DoublyLinkedNode_Sub2_Sub4) Static350.A_QUEUE___8.first(); local77 != null; local77 = (DoublyLinkedNode_Sub2_Sub4) Static350.A_QUEUE___8.next()) {
                ...
                if (local77.anInt1534 == 1) {
                    Static232.method3387(arg0, Static682.anInt10295, Static407.anInt6288, Static84.anInt1775 + local7, local89, Static634.anInt9510 | 0xFF000000, (DoublyLinkedNode_Sub2_Sub16) local77.aQueue_3.tail.next2, Static563.anInt8455 | 0xFF000000, local66, Static71.anInt1576 + local5, local55);
                } else {
