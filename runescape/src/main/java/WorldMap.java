...
public final class WorldMap {
    ...
    public static void method5063(@OriginalArg(0) Toolkit arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) short[] arg5, @OriginalArg(6) byte[] arg6) {
        ...
        for (@Pc(4) int local4 = 0; local4 < arg5.length; local4++) {
            @Pc(14) LocType local14 = locTypeList.list(arg5[local4] & 0xFFFF);
            @Pc(17) int local17 = local14.msi;
            if (local17 != -1) {
                @Pc(25) MSIType local25 = msiTypeList.list(local17);
    ...
    public static void method5079() {
        ...
        for (@Pc(4) int local4 = 0; local4 < staticElements.anInt6373; local4++) {
            @Pc(32) boolean local32 = area.method4088(local2, staticElements.anIntArray495[local4] & 0x3FFF, staticElements.anIntArray495[local4] >> 28 & 0x3, staticElements.anIntArray495[local4] >> 14 & 0x3FFF);
            if (local32) {
                @Pc(42) MapElementListEntry local42 = new MapElementListEntry(staticElements.anIntArray496[local4]);
