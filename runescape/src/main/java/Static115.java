    ...
    public static void method2136(@OriginalArg(1) int arg0) {
        ...
        if (arg0 != -1) {
            ...
            if (local32 == null) {
                ...
                Static446.aSignLink_6.method8995(local32.method9384(), local32.method9383(), Static434.aCanvas7, new Point(local28.anInt10303, local28.anInt10308), local32.method9378());
                Static470.anInt7112 = arg0;
            }
        }
        if (arg0 == -1 && Static470.anInt7112 != -1) {
            Static446.aSignLink_6.method8995(-1, (int[]) null, Static434.aCanvas7, new Point(), -1);
