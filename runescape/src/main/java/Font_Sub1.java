...
public final class Font_Sub1 extends Font {
    ...
    public final NativeToolkit aClass19_Sub1_2;
    ...
    public Font_Sub1(@OriginalArg(0) NativeToolkit arg0, @OriginalArg(1) FontMetrics arg1, @OriginalArg(2) IndexedImage[] arg2, @OriginalArg(3) boolean arg3) {
        super(arg0, arg1);
        ...
        if (arg3) {
            ...
            for (local46 = 0; local46 < 256; local46++) {
                ...
                local54 = local51.height;
                @Pc(57) int local57 = local51.width;
            ...
            for (local46 = 0; local46 < 256; local46++) {
                local51 = arg2[local46];
                @Pc(217) int[] local217 = local51.palette;
                @Pc(220) byte[] local220 = local51.alpha;
                @Pc(223) byte[] local223 = local51.raster;
        ...
        for (@Pc(366) int local366 = 0; local366 < 4; local366++) {
            ...
            if (local373 != null) {
                ...
                for (local63 = 0; local63 < 256; local63++) {
                    @Pc(408) IndexedImage local408 = arg2[local63];
                    local75 = local408.height;
                    local77 = local408.width;
                    local241 = local408.offY1;
                    local85 = local408.offX1;
    ...
    protected void fa(@OriginalArg(0) char c, @OriginalArg(1) int x, @OriginalArg(2) int y, @OriginalArg(3) int colour, @OriginalArg(4) boolean shadow) {
        ...
        @Pc(43) CompactMatrix local43 = this.aClass19_Sub1_2.method8040();
