...
public final class SkyBoxSphere {
    ...
    public static void method5058(@OriginalArg(0) Toolkit arg0) {
        ...
        for (@Pc(9) int i = 0; i < 64; i++) {
            @Pc(14) int local14 = 64 - i;
            @Pc(18) int local18 = local14 * local14;
            @Pc(24) int local24 = 128 - i - 1;
            @Pc(28) int local28 = i * 128;
            @Pc(32) int local32 = local24 * 128;
            for (@Pc(34) int j = 0; j < 64; j++) {
                @Pc(39) int local39 = 64 - j;
                @Pc(43) int local43 = local39 * local39;
                @Pc(49) int local49 = 128 - j - 1;
                ...
                local7[local28 + j] = local7[local28 + local49] = local7[local32 + j] = local7[local32 + local49] = (local59 | 0xFF00) << 16;
                local4[local28 + j] = local4[local28 + local49] = local4[local32 + j] = local4[local32 + local49] = 127 - local81 << 24 | 0xFFFFFF;
            }
        }
    ...
    public void method5055(@OriginalArg(0) Toolkit arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10) {
        ...
        @Pc(32) Matrix local32 = arg0.camera();
