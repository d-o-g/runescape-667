...
public final class Static28 {
    ...
    public static Sprite[] aSpriteArray1;
    ...
    public static void method746(@OriginalArg(0) int arg0, @OriginalArg(1) Class19 arg1, @OriginalArg(3) Class158 arg2, @OriginalArg(4) int arg3) {
        ...
        Static12.aSprite_26.method8185((float) arg3 + (float) arg2.anInt3802 / 2.0F, (float) arg2.anInt3746 / 2.0F + (float) arg0, (float) local120, (float) local137, local79, local87 << 2, local30, arg3, arg0);
        @Pc(190) int local190;
        @Pc(200) int local200;
        @Pc(211) int local211;
        @Pc(222) int local222;
        ...
        for (@Pc(334) ObjStack local334 = (ObjStack) Static497.stacks.first(); local334 != null; local334 = (ObjStack) Static497.stacks.next()) {
            ...
            if (Static643.anInt9604 == local211) {
                ...
                Static6.method107(arg0, local30, Static471.aSpriteArray11[0], local392, local381, arg2, arg3);
            }
        }
        @Pc(490) int local490;
        ...
        for (local381 = 0; local381 < local222; local381++) {
            ...
            if (local541 != null && local541.method1417() && !local541.aBoolean124 && Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2 != local541 && local541.aByte144 == Static556.aClass8_Sub2_Sub1_Sub2_Sub1_2.aByte144) {
                ...
                if (local541.aBoolean128) {
                    Static6.method107(arg0, local30, Static471.aSpriteArray11[6], local585, local490, arg2, arg3);
                } else if (local652) {
                    Static6.method107(arg0, local30, Static471.aSpriteArray11[4], local585, local490, arg2, arg3);
                } else if (local541.aBoolean125) {
                    Static6.method107(arg0, local30, Static471.aSpriteArray11[7], local585, local490, arg2, arg3);
                } else if (local587) {
                    Static6.method107(arg0, local30, Static471.aSpriteArray11[3], local585, local490, arg2, arg3);
                } else if (local620) {
                    Static6.method107(arg0, local30, Static471.aSpriteArray11[5], local585, local490, arg2, arg3);
                } else {
                    Static6.method107(arg0, local30, Static471.aSpriteArray11[2], local585, local490, arg2, arg3);
                }
            }
        }
