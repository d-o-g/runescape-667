...
public final class Class108 {
    ...
    public void method2446(@OriginalArg(0) int arg0, @OriginalArg(2) Node_Sub21 arg1) {
        if (arg0 == 1) {
            ...
            this.anIntArray232 = new int[arg1.method7396()];
            for (@Pc(26) int local26 = 0; local26 < this.anIntArray232.length; local26++) {
                this.anIntArray232[local26] = arg1.method7382();
            }
        } else if (arg0 == 3) {
            this.anInt2624 = arg1.method7396();
        } else if (arg0 == 4) {
            this.anInt2625 = arg1.method7396();
        } else if (arg0 == 5) {
            this.anInt2621 = arg1.method7382();
            return;
        }
    }
