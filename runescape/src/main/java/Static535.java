                    ...
                    if (local23 >= 0 && local23 < Static619.anInt1566) {
                        for (@Pc(35) int local35 = local11; local35 <= local15; local35++) {
                            if (local35 >= 0 && local35 < Static662.anInt9843 && (!local1 || local23 >= local7 || local35 >= local15 || local35 < arg3 && local23 != arg2)) {
                                ...
                                if (local77 != null) {
                                    @Pc(163) int local163 = (Static246.aGroundArray1[local17].method7869(local35, local23) + Static246.aGroundArray1[local17].method7869(local35, local23 + 1) + Static246.aGroundArray1[local17].method7869(local35 + 1, local23) + Static246.aGroundArray1[local17].method7869(local35 + 1, local23 + 1)) / 4 - (Static246.aGroundArray1[arg1].method7869(arg3, arg2) + Static246.aGroundArray1[arg1].method7869(arg3, arg2 + 1) + Static246.aGroundArray1[arg1].method7869(arg3 + 1, arg2) + Static246.aGroundArray1[arg1].method7869(arg3 + 1, arg2 + 1)) / 4;
