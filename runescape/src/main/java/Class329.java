...
public final class Class329 {
    ...
    public Class329(@OriginalArg(0) GlToolkit arg0) {
        this.aBoolean655 = arg0.aBoolean606;
        Static491.method9159(arg0);
        if (this.aBoolean655) {
            @Pc(31) byte[] local31 = ByteArrayWrapper.unwrap(false, Static599.anObject14);
            this.aClass93_Sub3_2 = new Class93_Sub3(arg0, 6410, 128, 128, 16, local31, 6410);
            @Pc(48) byte[] local48 = ByteArrayWrapper.unwrap(false, Static158.anObject5);
            ...
            if (local63.method4582()) {
                local31 = ByteArrayWrapper.unwrap(false, Static71.anObject4);
            ...
            for (@Pc(125) int local125 = 0; local125 < 16; local125++) {
                @Pc(138) byte[] local138 = ByteArrayWrapper.unwrap(32768, Static599.anObject14, local125 * 2 * 128 * 128);
            ...
            for (@Pc(164) int local164 = 0; local164 < 16; local164++) {
                @Pc(175) byte[] local175 = ByteArrayWrapper.unwrap(32768, Static158.anObject5, local164 * 128 * 256);
