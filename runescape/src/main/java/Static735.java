...
public final class Static735 {
    ...
    public static Class407[] method9376(@OriginalArg(0) byte[] arg0) {
        ...
        for (@Pc(58) int local58 = 0; local58 < local14; local58++) {
            local17[local58].anInt10852 = local4.g2();
        }
        for (@Pc(72) int local72 = 0; local72 < local14; local72++) {
            local17[local72].anInt10848 = local4.g2();
        }
        for (@Pc(86) int local86 = 0; local86 < local14; local86++) {
            local17[local86].anInt10847 = local4.g2();
        }
        for (@Pc(100) int local100 = 0; local100 < local14; local100++) {
            local17[local100].anInt10850 = local4.g2();
        }
                ...
                if ((local217 & 0x1) == 0) {
                    ...
                    for (local227 = 0; local227 < local203.anInt10847; local227++) {
                        for (local245 = 0; local245 < local203.anInt10850; local245++) {
                            local203.aByteArray114[local227 + local245 * local203.anInt10847] = local4.g1b();
                        }
                    }
                }
            } else {
                ...
                if ((local217 & 0x1) == 0) {
                    ...
                    for (local245 = 0; local245 < local203.anInt10847; local245++) {
                        for (local295 = 0; local295 < local203.anInt10850; local295++) {
                            local203.aByteArray114[local245 + local295 * local203.anInt10847] = local4.g1b();
                        }
                    }
                    for (local295 = 0; local295 < local203.anInt10847; local295++) {
                        for (@Pc(352) int local352 = 0; local352 < local203.anInt10850; local352++) {
                            @Pc(367) byte local367 = local203.aByteArray115[local295 + local352 * local203.anInt10847] = local4.g1b();
                            local271 |= local367 != -1;
                        }
                    }
                }
    ...
    public static Class407 method9379(@OriginalArg(0) js5 arg0, @OriginalArg(1) int arg1) {
        @Pc(4) byte[] local4 = arg0.getfile(arg1);
