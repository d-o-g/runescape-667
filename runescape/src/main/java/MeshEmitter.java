...
public final class MeshEmitter {
    ...
    public final int anInt8506;

    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(IIIIB)V")
    public MeshEmitter(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4) {
        this.aByte130 = arg4;
        this.anInt8514 = arg1;
        this.anInt8508 = arg2;
        this.anInt8505 = arg3;
    ...
    public MeshEmitter method7554(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
        return new MeshEmitter(this.anInt8506, arg0, arg1, arg2, this.aByte130);
    }
}
