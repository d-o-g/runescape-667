...
public final class Node_Sub2_Sub12 extends Node_Sub2 {
    ...
    public void method3899(@OriginalArg(0) Node_Sub21 arg0) {
        while (true) {
    ...
    public String method3903(@OriginalArg(1) Node_Sub21 arg0) {
        ...
        if (this.anIntArray331 != null) {
            for (@Pc(15) int local15 = 0; local15 < this.anIntArray331.length; local15++) {
                ...
                local10.append(this.aClass139_1.method2948(this.method3898(local15), arg0.method7407(Static446.method6091(this.anIntArray331[local15]).anInt4577), this.anIntArrayArray101[local15]));
            }
        }
    ...
    public void method3904(@OriginalArg(0) Node_Sub21 arg0, @OriginalArg(1) int[] arg1) {
        if (this.anIntArray331 == null) {
            return;
        }
        for (@Pc(15) int local15 = 0; local15 < this.anIntArray331.length; local15++) {
            ...
            if (local22 > 0) {
                arg0.method7369(local22, (long) arg1[local15]);
            }
        }
    }
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lclient!ge;II)V")
    public void method3907(@OriginalArg(0) Node_Sub21 arg0, @OriginalArg(2) int arg1) {
        if (arg1 == 1) {
            this.aStringArray23 = Static189.method2861(arg0.method7358(), '<');
            return;
        }
        @Pc(21) int local21;
        @Pc(27) int local27;
        if (arg1 == 2) {
            ...
            for (local27 = 0; local27 < local21; local27++) {
                this.anIntArray333[local27] = arg0.method7382();
            }
        } else if (arg1 == 3) {
            local21 = arg0.method7396();
            ...
            for (local27 = 0; local27 < local21; local27++) {
                @Pc(71) int local71 = arg0.method7382();
                ...
                if (local75 != null) {
                    ...
                    for (@Pc(91) int local91 = 0; local91 < local75.anInt4573; local91++) {
                        this.anIntArrayArray101[local27][local91] = arg0.method7382();
                    }
                }
            }
        } else if (arg1 == 4) {
