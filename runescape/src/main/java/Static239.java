...
public final class Static239 {
    ...
    public static void method3472(@OriginalArg(1) js5 arg0, @OriginalArg(2) Toolkit arg1) {
        ...
        for (@Pc(14) int local14 = 0; local14 < local8.length; local14++) {
            Static119.aSpriteArray3[local14] = arg1.createSprite(local8[local14], true);
        }
        ...
        for (@Pc(44) int local44 = 0; local44 < local8.length; local44++) {
            Static34.aSpriteArray2[local44] = arg1.createSprite(local8[local44], true);
        }
        ...
        for (@Pc(74) int local74 = 0; local74 < local8.length; local74++) {
            Static441.aSpriteArray10[local74] = arg1.createSprite(local8[local74], true);
        }
        ...
        for (@Pc(112) int local112 = 0; local112 < local8.length; local112++) {
            Static493.aSpriteArray12[local112] = arg1.createSprite(local8[local112], true);
        }
        ...
        for (@Pc(138) int local138 = 0; local138 < local8.length; local138++) {
            Static28.aSpriteArray1[local138] = arg1.createSprite(local8[local138], true);
        }
        ...
        for (@Pc(168) int local168 = 0; local168 < local8.length; local168++) {
            Static174.aSpriteArray4[local168] = arg1.createSprite(local8[local168], true);
        }
        ...
        for (@Pc(198) int local198 = 0; local198 < local8.length; local198++) {
            Static691.aSpriteArray15[local198] = arg1.createSprite(local8[local198], true);
        }
        ...
        for (@Pc(228) int local228 = 0; local228 < local8.length; local228++) {
            Static355.aSpriteArray9[local228] = arg1.createSprite(local8[local228], true);
        }
        ...
        for (@Pc(258) int local258 = 0; local258 < local8.length; local258++) {
            Static471.aSpriteArray11[local258] = arg1.createSprite(local8[local258], true);
        }
        ...
        for (@Pc(284) int local284 = 0; local284 < local8.length; local284++) {
            Static291.aSpriteArray8[local284] = arg1.createSprite(local8[local284], true);
        }
        ...
        for (@Pc(310) int local310 = 0; local310 < local8.length; local310++) {
            Static679.aSpriteArray14[local310] = arg1.createSprite(local8[local310], true);
        }
        Static12.aSprite_27 = arg1.createSprite(IndexedImage.loadFirst(arg0, Static670.anInt10024, 0), true);
        Static517.aSprite_32 = arg1.createSprite(IndexedImage.loadFirst(arg0, Static286.anInt4592, 0), true);
        ...
        for (@Pc(352) int local352 = 0; local352 < local8.length; local352++) {
            Static558.aSpriteArray7[local352] = arg1.createSprite(local8[local352], true);
        }
    }
