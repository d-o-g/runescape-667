...
public final class Class337 {
    ...
    public final Class8_Sub2 aClass8_Sub2_21;
    ...
    public void method7676(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) boolean arg2) {
        ...
        if (arg1 == -1) {
            ...
            if (local21.method1300()) {
                if (arg2 && this.aAnimator_9.isAnimating() && local21.method1298(this.aAnimator_9.getAnimationId())) {
                    return;
                }
                ...
                if (arg2 && this.aAnimator_9.isAnimating() && local23.method1298(this.aAnimator_9.getAnimationId())) {
                    return;
                }
                if (this.anInt8647 != local21.anInt1256) {
    ...
    public Model method7678(@OriginalArg(0) Toolkit arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4) {
        ...
        if (this.aAnimator_9.isAnimating()) {
            ...
            this.aModel_8 = null;
        } else if (this.aModel_8 != null && (arg4 & this.aModel_8.ua()) == arg4 && local11.anInt1256 == this.anInt8647) {
            ...
            if (local389 == null) {
                ...
                local171 = local389.aModel_7;
                this.aModel_8 = local389.aModel_7;
                if (arg3) {
