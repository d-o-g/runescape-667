...
public final class Node_Sub1_Sub9 extends TextureOp {
    ...
    public void method2841(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
    ...
    public void method2845(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
    ...
    public int[][] method9414(@OriginalArg(0) int arg0) {
        @Pc(22) int[][] local22 = super.colourCache.get(arg0);
        if (super.colourCache.dirty) {
            ...
            for (@Pc(58) int local58 = 0; local58 < EnvironmentLight.anInt9289; local58++) {
