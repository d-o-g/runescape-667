...
public abstract class Class61 {
    ...
    protected final D3DToolkit aClass19_Sub1_Sub1_9;

    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Lclient!kea;Lclient!eba;Lclient!wda;ZI)V")
    protected Class61(@OriginalArg(0) D3DToolkit arg0, @OriginalArg(1) Class92 arg1, @OriginalArg(2) Class397 arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4) {
