...
public final class js5 {
    ...
    public boolean fileExists(@OriginalArg(0) String groupName, @OriginalArg(2) String fileName) {
        ...
        @Pc(25) int groupId = this.index.groupNameTable.find(Cp1252.hash(groupNameLower));
        if (groupId >= 0) {
            @Pc(41) int fileId = this.index.fileNameTables[groupId].find(Cp1252.hash(fileNameLower));
            return fileId >= 0;
        } else {
            return false;
        }
    ...
    public boolean groupExists(@OriginalArg(0) String groupName) {
        if (this.indexReady()) {
            ...
            @Pc(30) int groupId = this.index.groupNameTable.find(Cp1252.hash(groupNameLower));
            return groupId >= 0;
        } else {
            return false;
        }
    ...
    public int getgroupid(@OriginalArg(0) String groupName) {
        if (this.indexReady()) {
            ...
            @Pc(28) int groupId = this.index.groupNameTable.find(Cp1252.hash(groupNameLower));
    ...
    public int completePercentage(@OriginalArg(1) String groupName) {
        if (this.indexReady()) {
            ...
            @Pc(33) int groupId = this.index.groupNameTable.find(Cp1252.hash(groupNameLower));
    ...
    public boolean requestgroupdownload(@OriginalArg(0) String groupName) {
        if (this.indexReady()) {
            @Pc(13) String groupNameLower = groupName.toLowerCase();
            @Pc(22) int groupId = this.index.groupNameTable.find(Cp1252.hash(groupNameLower));
    ...
    public byte[] getfile(@OriginalArg(0) String groupName, @OriginalArg(1) String fileName) {
        ...
        @Pc(25) int groupId = this.index.groupNameTable.find(Cp1252.hash(groupNameLower));
        if (this.isValidGroup(groupId)) {
            @Pc(53) int local53 = this.index.fileNameTables[groupId].find(Cp1252.hash(fileNameLower));
    ...
    public void requestGroup(@OriginalArg(0) String groupName) {
        if (this.indexReady()) {
            ...
            @Pc(29) int local29 = this.index.groupNameTable.find(Cp1252.hash(local12));
    ...
    public boolean requestdownload(@OriginalArg(1) String groupName, @OriginalArg(2) String fileName) {
        ...
        @Pc(25) int groupId = this.index.groupNameTable.find(Cp1252.hash(groupNameLower));
        if (this.isValidGroup(groupId)) {
            @Pc(44) int fileId = this.index.fileNameTables[groupId].find(Cp1252.hash(fileNameLower));
