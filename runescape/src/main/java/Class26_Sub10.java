...
public final class Class26_Sub10 extends Class26 {
    ...
    public final D3DToolkit aClass19_Sub1_Sub1_8;
    ...
    public final IDirect3DVertexShader anIDirect3DVertexShader8;

    @OriginalMember(owner = "client!rn", name = "k", descriptor = "Lclient!jagdx/IDirect3DPixelShader;")
    public final IDirect3DPixelShader anIDirect3DPixelShader1;
    ...
    public Class26_Sub10(@OriginalArg(0) D3DToolkit arg0, @OriginalArg(1) js5 arg1, @OriginalArg(2) Class7 arg2) {
        super(arg0);
        ...
        if (arg1 != null && this.aClass19_Sub1_21.aBoolean685 && this.aClass19_Sub1_21.aBoolean696 && (this.aClass19_Sub1_Sub1_8.aD3DCAPS1.VertexShaderVersion & 0xFFFF) >= 257) {
            this.anIDirect3DVertexShader8 = this.aClass19_Sub1_Sub1_8.anIDirect3DDevice1.b(arg1.getfile("dx", "environment_mapped_water_v"));
            this.anIDirect3DPixelShader1 = this.aClass19_Sub1_Sub1_8.anIDirect3DDevice1.a(arg1.getfile("dx", "environment_mapped_water_f"));
    ...
    public void method8288() {
        ...
        @Pc(13) CompactMatrix local13 = this.aClass19_Sub1_Sub1_8.method8118();
        @Pc(18) CompactMatrix local18 = this.aClass19_Sub1_Sub1_8.method8154();
    ...
    public void method8285() {
        if (this.aBoolean643) {
            ...
            @Pc(11) CompactMatrix local11 = this.aClass19_Sub1_Sub1_8.method8154();
    ...
    public void method8296() {
        if (this.aBoolean643) {
            @Pc(8) IDirect3DDevice local8 = this.aClass19_Sub1_Sub1_8.anIDirect3DDevice1;
            @Pc(13) CompactMatrix local13 = this.aClass19_Sub1_21.method8066();
