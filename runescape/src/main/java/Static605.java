...
public final class Static605 {
    ...
    public static void method7912(@OriginalArg(1) Class287 arg0) {
        ...
        if (arg0 == Static704.aClass287_17) {
            ...
            local42 = local8.method7382();
            local46 = local8.method7382();
            local52 = local8.method7382();
            if (Static497.aClass28_35 != null) {
                @Pc(69) Node_Sub17 local69 = (Node_Sub17) Static497.aClass28_35.method738((long) (Static87.anInt1810 << 28 | local25 << 14 | local38));
                if (local69 != null) {
        ...
        if (Static379.aClass287_12 == arg0) {
            local15 = local8.method7374();
            local21 = local15 >> 2;
            local25 = Static310.anIntArray379[local21];
            local34 = local8.method7396();
            local38 = local8.method7376();
            ...
            if ((local34 & 0x1) == 1) {
                ...
                if ((local34 & 0x2) == 2) {
                    ...
                    for (local290 = 0; local290 < local212; local290++) {
                        local278[local290] = local8.method7382();
                    }
                }
                ...
                if ((local34 & 0x4) == 4) {
                    ...
                    for (local322 = 0; local322 < local217; local322++) {
                        local310[local322] = (short) local8.method7382();
                    }
                }
                ...
                if ((local34 & 0x8) == 8) {
                    ...
                    for (local353 = 0; local353 < local219; local353++) {
                        local343[local353] = (short) local8.method7382();
                    }
                }
            ...
            local15 = local8.method7382();
            local21 = local8.method7396();
            ...
            if (arg0 == Static481.aClass287_15) {
                ...
                local46 = local38 & 0x7;
                local52 = local8.method7396();
                local537 = local8.method7396();
                local212 = local8.method7382();
                ...
                if (arg0 == Static3.aClass287_1) {
                    ...
                    local52 = local8.method7377() + local21;
                    local537 = local25 + local8.method7377();
                    local212 = local8.method7356();
                    local217 = local8.method7356();
                    local219 = local8.method7382();
                    local812 = local8.method7396();
                    if (local773) {
                        local812 = (byte) local812;
                    } else {
                        local812 *= 4;
                    }
                    local290 = local8.method7396() * 4;
                    local322 = local8.method7382();
                    local353 = local8.method7382();
                    @Pc(843) int local843 = local8.method7396();
                    @Pc(847) int local847 = local8.method7382();
                    if (local843 == 255) {
                        local843 = -1;
                    }
                    if (local21 >= 0 && local25 >= 0 && local21 < Static720.anInt10859 * 2 && local25 < Static720.anInt10859 * 2 && local52 >= 0 && local537 >= 0 && Static501.anInt7568 * 2 > local52 && Static501.anInt7568 * 2 > local537 && local219 != 65535) {
                        ...
                        if (local212 != 0 && local46 != -1) {
                            ...
                            if (local212 >= 0) {
                                local957 = local212 - 1;
                                @Pc(964) Node_Sub45 local964 = (Node_Sub45) Static18.aClass28_2.method738((long) local957);
                                if (local964 != null) {
                        ...
                        Static505.aClass339_77.method7711(new Node_Sub2_Sub15(local1053));
                    }
                    ...
                    if (local15 != Static312.anInt5000) {
                        ...
                        if (local1151 || Static55.method1218(Static117.anInt2282)) {
                            Static2.method63(Static87.anInt1810, local34, local42, new Node_Sub15(local46, local52));
                            if (local1151) {
                    ...
                    @Pc(1389) Node_Sub17 local1389 = (Node_Sub17) Static497.aClass28_35.method738((long) (local34 << 14 | Static87.anInt1810 << 28 | local42));
                    if (local1389 != null) {
                    ...
                    @Pc(1511) String local1511 = local8.method7358();
                    ...
                    local38 = local25 + local8.method7377();
                    local42 = local34 + local8.method7377();
                    local46 = local8.method7356();
                    local52 = local8.method7382();
                    local537 = local8.method7396() * 4;
                    local212 = local8.method7396() * 4;
                    local217 = local8.method7382();
                    local219 = local8.method7382();
                    local812 = local8.method7396();
                    local290 = local8.method7382();
                    if (local812 == 255) {
                        local812 = -1;
                    }
                    if (local25 >= 0 && local34 >= 0 && Static720.anInt10859 > local25 && local34 < Static501.anInt7568 && local38 >= 0 && local42 >= 0 && Static720.anInt10859 > local38 && local42 < Static501.anInt7568 && local52 != 65535) {
                        ...
                        Static505.aClass339_77.method7711(new Node_Sub2_Sub15(local1728));
                    }
                } else if (Static210.aClass287_9 == arg0) {
                    local15 = local8.method7401();
                    local21 = Static626.anInt9476 + (local15 >> 4 & 0x7);
                    local25 = (local15 & 0x7) + Static270.anInt4354;
                    local34 = local8.method7396();
                    local38 = local34 >> 2;
                    ...
                    if (local1886 || Static55.method1218(Static117.anInt2282)) {
                        Static2.method63(Static87.anInt1810, local25, local38, new Node_Sub15(local42, local46));
                        if (local1886) {
                            Static468.method7641(Static87.anInt1810, local21, local34);
                        }
                    }
                    ...
                    if (local21 >= 0 && local25 >= 0 && local21 < Static720.anInt10859 && Static501.anInt7568 > local25) {
                        if (local34 == -1) {
                            ...
                            Static346.aClass28_29.method735((long) (local21 << 16 | local25), new Node_Sub2_Sub20(local2065));
                        }
                    }
                } else {
