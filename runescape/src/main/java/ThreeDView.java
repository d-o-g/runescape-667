...
public final class ThreeDView {
    ...
    public static void doOpPlayer(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
        ...
        for (@Pc(19) int i = 0; i < count; i++) {
            ...
            if (player != null && PlayerEntity.self != player && player.accountName != null && player.accountName.equalsIgnoreCase(arg0)) {
    ...
    public static void doTargetPlayer(@OriginalArg(1) String arg0) {
        ...
        for (@Pc(28) int i = 0; i < count; i++) {
            ...
            if (player.accountName != null && player.accountName.equalsIgnoreCase(arg0) && (PlayerEntity.self == player && (InterfaceManager.targetMask & TargetMask.TGT_SELF) != 0 || (InterfaceManager.targetMask & TargetMask.TGT_PLAYER) != 0)) {
