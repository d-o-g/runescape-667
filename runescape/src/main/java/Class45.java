...
public final class Class45 {
    ...
    public final js5 aJs5_9;

    @OriginalMember(owner = "client!bka", name = "<init>", descriptor = "(Lclient!ul;ILclient!sb;)V")
    public Class45(@OriginalArg(0) Class377 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) js5 arg2) {
        this.aJs5_9 = arg2;
        if (this.aJs5_9 != null) {
            this.aJs5_9.method7608(35);
        }
    }
    ...
    public Class218 method1094(@OriginalArg(0) int arg0) {
        ...
        @Pc(30) js5 local30 = this.aJs5_9;
        @Pc(39) byte[] local39;
        synchronized (this.aJs5_9) {
            local39 = this.aJs5_9.method7595(arg0, 35);
        }
