...
public final class Model_Sub1 extends Model {
    ...
    public Model_Sub1(@OriginalArg(0) Toolkit_Sub1 arg0, @OriginalArg(1) Mesh arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
        ...
        if (arg1.billboards != null) {
            ...
            for (local494 = 0; local494 < this.anInt2713; local494++) {
                ...
                local566 = Static154.anIntArray237[arg1.faceColour[local503.anInt588] & 0xFFFF] & 0xFFFFFF;
                @Pc(585) int local585 = local566 | 255 - (arg1.faceTexSpace == null ? 0 : arg1.faceTexSpace[local503.anInt588]) << 24;
                this.aClass298Array1[local494] = new Class298(local510, arg1.faceA[local503.anInt588], arg1.faceB[local503.anInt588], arg1.faceC[local503.anInt588], local508.anInt9696, local508.anInt9690, local508.anInt9693, local508.anInt9697, local508.anInt9689, local508.aBoolean747, local508.aBoolean748, local503.anInt591);
        ...
        for (local566 = 0; local566 < arg1.faceCount; local566++) {
            ...
            @Pc(990) byte local990 = arg1.shadingTypes == null ? 0 : arg1.shadingTypes[local566];
            if (local990 == 0) {
        ...
        for (local184 = 0; local184 < this.anInt2715; local184++) {
                ...
                if (local819 == -1) {
                    ...
                    if (local1221 == 0) {
                        ...
                        if (local1221 == 1) {
                            ...
                            Static89.method1715(local1626, local1274, local1621, arg1.vertexX[local1231], local1631, Static346.aFloatArray40, local1283, local1616, arg1.vertexY[local1231], arg1.vertexZ[local1231], local1611);
                            local1188 = Static346.aFloatArray40[0];
                            local1190 = Static346.aFloatArray40[1];
                            Static89.method1715(local1626, local1274, local1621, arg1.vertexX[local1236], local1631, Static346.aFloatArray40, local1283, local1616, arg1.vertexY[local1236], arg1.vertexZ[local1236], local1611);
                            local1192 = Static346.aFloatArray40[0];
                            local1194 = Static346.aFloatArray40[1];
                            Static89.method1715(local1626, local1274, local1621, arg1.vertexX[local1241], local1631, Static346.aFloatArray40, local1283, local1616, arg1.vertexY[local1241], arg1.vertexZ[local1241], local1611);
                            ...
                            Static57.method1224(local1274, local1204, arg1.vertexX[local1231], local1283, local1616, Static346.aFloatArray40, arg1.vertexY[local1231], arg1.vertexZ[local1231], local1611, local1621, local1292, local1626, local1631);
                            local1188 = Static346.aFloatArray40[0];
                            local1190 = Static346.aFloatArray40[1];
                            Static57.method1224(local1274, local1204, arg1.vertexX[local1236], local1283, local1616, Static346.aFloatArray40, arg1.vertexY[local1236], arg1.vertexZ[local1236], local1611, local1621, local1292, local1626, local1631);
                            local1192 = Static346.aFloatArray40[0];
                            local1194 = Static346.aFloatArray40[1];
                            Static57.method1224(local1274, local1204, arg1.vertexX[local1241], local1283, local1616, Static346.aFloatArray40, arg1.vertexY[local1241], arg1.vertexZ[local1241], local1611, local1621, local1292, local1626, local1631);
                            local1196 = Static346.aFloatArray40[0];
                            local1198 = Static346.aFloatArray40[1];
                        } else if (local1221 == 3) {
                            Static397.method5556(local1611, arg1.vertexZ[local1231], arg1.vertexY[local1231], Static346.aFloatArray40, local1621, local1274, local1626, local1631, arg1.vertexX[local1231], local1616);
                            local1188 = Static346.aFloatArray40[0];
                            local1190 = Static346.aFloatArray40[1];
                            Static397.method5556(local1611, arg1.vertexZ[local1236], arg1.vertexY[local1236], Static346.aFloatArray40, local1621, local1274, local1626, local1631, arg1.vertexX[local1236], local1616);
                            local1192 = Static346.aFloatArray40[0];
                            local1194 = Static346.aFloatArray40[1];
                            Static397.method5556(local1611, arg1.vertexZ[local1241], arg1.vertexY[local1241], Static346.aFloatArray40, local1621, local1274, local1626, local1631, arg1.vertexX[local1241], local1616);
                            local1198 = Static346.aFloatArray40[1];
                            local1196 = Static346.aFloatArray40[0];
                            if ((local1631 & 0x1) == 0) {
            ...
            if (arg1.shadingTypes == null) {
                ...
                local1221 = arg1.shadingTypes[local1120];
            }
            if (local1221 == 0) {
        ...
        if (arg1.vertexGroup != null && Static1.method9338(this.anInt2765, arg2)) {
        ...
        if (arg1.faceGroup != null && Static176.method6689(-1, this.anInt2765, arg2)) {
            local1120 = 0;
            @Pc(3065) int[] local3065 = new int[256];
            for (local819 = 0; local819 < this.anInt2715; local819++) {
                local830 = arg1.faceGroup[local15[local819]];
                if (local830 >= 0) {
            ...
            for (local841 = 0; local841 < this.anInt2715; local841++) {
                local852 = arg1.faceGroup[local15[local841]];
                if (local852 >= 0) {
    ...
    public Model copy(@OriginalArg(0) byte arg0, @OriginalArg(1) int mask, @OriginalArg(2) boolean arg2) {
        ...
        return this.method2557(mask, local23, arg2, local5, local24);
    }
    ...
    public void transform(@OriginalArg(0) Matrix matrix, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
        ...
        for (@Pc(15) int local15 = 0; local15 < this.anInt2773; local15++) {
            if ((this.aShortArray41[local15] & arg1) != 0) {
                if (arg2) {
                    matrix.method7140(this.anIntArray240[local15], this.anIntArray242[local15], this.anIntArray244[local15], local13);
                } else {
                    matrix.method7124(this.anIntArray240[local15], this.anIntArray242[local15], this.anIntArray244[local15], local13);
                }
