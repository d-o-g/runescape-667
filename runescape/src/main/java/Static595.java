...
public final class Static595 {
    ...
    public static void method7807(@OriginalArg(1) String arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) int toolkit) {
        ...
        if (toolkit == ToolkitType.JAVA) {
            ...
            @Pc(85) Font local85;
            if (arg0 != null) {
                local57 = Static255.method3612(js5.SHADERS, Js5TextureSource.instance, 0, GameShell.canvas, 0);
                local57.GA(0);
            ...
            label216:
            {
                try {
                    var14 = true;
                    Toolkit.active = Static255.method3612(js5.SHADERS, Js5TextureSource.instance, toolkit, GameShell.canvas, ClientOptions.instance.antialiasingQuality.getValue() * 2);
                    if (arg0 != null) {
                        local57.GA(0);
