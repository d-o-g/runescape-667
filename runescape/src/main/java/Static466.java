...
public final class Static466 {
    ...
    public static void method6324(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) boolean arg10, @OriginalArg(12) int arg11, @OriginalArg(13) int[] arg12, @OriginalArg(14) byte[][][] arg13, @OriginalArg(15) int[] arg14, @OriginalArg(16) int arg15) {
        ...
        @Pc(13) int[] local13 = Static74.aToolkit_4.Y();
        ...
        if (!Static75.aBoolean521) {
            ...
            if (local152 >= 0 && local159 >= 0 && Static571.anInt8534 >= local163 && local167 <= Static576.anInt8585 || Static448.anInt6796 == 2) {
                ...
                if (Static448.anInt6796 == 0) {
                    Static74.aToolkit_4.method7939(Static450.anInterface9_1);
                }
                Static74.aToolkit_4.F(-local250, -local252);
                Static74.aToolkit_4.b(local340, local386, local338, local393, local258);
                ...
                if (local395 > 0) {
                    Static74.aToolkit_4.KA(0, local388, Static571.anInt8534, local388 + local395);
                    Static74.aToolkit_4.ya();
                    Static74.aToolkit_4.GA(Static551.anInt8289);
                    Static283.method4100(arg7, arg1, arg3, arg2, arg13, arg9, arg12, arg5, arg14, arg6, arg8, arg0, arg15, arg4, arg10, arg11, 1, false);
                }
                if (local342 > 0) {
                    Static74.aToolkit_4.KA(local344, local397, local342 + local344, local393 + local397);
                    Static74.aToolkit_4.ya();
                    Static74.aToolkit_4.GA(Static551.anInt8289);
                    Static283.method4100(arg7, arg1, arg3, arg2, arg13, arg9, arg12, arg5, arg14, arg6, arg8, arg0, arg15, arg4, arg10, arg11, 1, false);
                }
        ...
        if (Static75.aBoolean521) {
            ...
            Static74.aToolkit_4.setCamera(Static420.aMatrix_7);
            if (Static448.anInt6796 == 1) {
        ...
        if (Static448.anInt6796 == 0 || Static448.anInt6796 == 2) {
            ...
            Static246.anInt3986 = local33;
            Static74.aToolkit_4.DA(Static213.anInt3469, Static524.anInt8043, Static46.anInt1001, Static246.anInt3986);
            Static74.aToolkit_4.KA(Static2.anInt45, Static312.anInt5001, Static2.anInt45 + Static252.anInt4078, Static281.anInt4566 + Static312.anInt5001);
        }
        ...
        Static74.aToolkit_4.la();
        Static74.aToolkit_4.DA(local17, local21, local25, local29);
    }
                ...
                for (@Pc(225) int local225 = 0; local225 < Static501.anInt7568 >> 3; local225++) {
                    ...
                    if (local235 != -1) {
                        ...
                        if (local261 != -1) {
                            ...
                            Static267.anIntArray329[local50] = Static93.aJs5_16.method7590("m" + local299 + "_" + local303);
                            Static266.anIntArray615[local50] = Static93.aJs5_16.method7590("l" + local299 + "_" + local303);
                            Static68.anIntArray316[local50] = Static93.aJs5_16.method7590("um" + local299 + "_" + local303);
                            Static298.anIntArray367[local50] = Static93.aJs5_16.method7590("ul" + local299 + "_" + local303);
                            local50++;
                        }
                    }
                }
