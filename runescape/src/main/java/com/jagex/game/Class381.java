...
public final class Class381 {
                ...
                if (local178 != 32 && local178 != 160) {
                    for (local142 = 0; local142 < 256; local142++) {
                        if (local142 != 32 && local142 != 160) {
                            this.aByteArrayArray34[local178][local142] = (byte) method5225(local62, local142, local46, local178, local78, this.aByteArray106, local128);
                        }
                    }
                }
            }
    ...
    public int method8739(@OriginalArg(0) String arg0, @OriginalArg(1) Sprite[] arg1, @OriginalArg(3) int arg2) {
        return this.method8740(aStringArray43, new int[]{arg2}, arg1, arg0);
    }

    @OriginalMember(owner = "client!ve", name = "a", descriptor = "([Ljava/lang/String;[II[Lclient!st;Ljava/lang/String;)I")
    public int method8740(@OriginalArg(0) String[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(3) Sprite[] arg2, @OriginalArg(4) String arg3) {
        if (arg3 == null) {
            return 0;
        }
        @Pc(10) int local10 = 0;
    ...
    public int method8741(@OriginalArg(0) Sprite[] arg0, @OriginalArg(2) String arg1, @OriginalArg(3) int arg2) {
        @Pc(16) int local16 = this.method8740(aStringArray43, new int[]{arg2}, arg0, arg1);
        @Pc(18) int local18 = 0;
        for (@Pc(20) int local20 = 0; local20 < local16; local20++) {
            @Pc(29) int local29 = this.method8742(arg0, aStringArray43[local20]);
            if (local18 < local29) {
                local18 = local29;
            }
        }
    ...
    public int method8742(@OriginalArg(1) Sprite[] arg0, @OriginalArg(2) String arg1) {
        if (arg1 == null) {
            return 0;
        }
        @Pc(10) int local10 = -1;
    ...
    public String method8743(@OriginalArg(0) String arg0, @OriginalArg(1) Sprite[] arg1, @OriginalArg(2) int arg2) {
        if (arg2 >= this.method8742(arg1, arg0)) {
            return arg0;
        }
        @Pc(27) int local27 = arg2 - this.method8742((Sprite[]) null, "...");
        @Pc(29) int local29 = -1;
        @Pc(31) int local31 = -1;
        @Pc(33) int local33 = 0;
    ...
    public int method8744(@OriginalArg(1) String arg0) {
        return this.method8742((Sprite[]) null, arg0);
    }

    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IILjava/lang/String;[Lclient!st;B)I")
    public int method8745(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) Sprite[] arg3) {
        if (arg1 == 0) {
            arg1 = this.anInt10027;
        }
        @Pc(24) int local24 = this.method8740(aStringArray43, new int[]{arg0}, arg3, arg2);
