...
public final class Static147 {
    ...
    public static boolean findPath(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7) {
        ...
        if (local16 < 0 || local16 >= Static720.mapWidth || local21 < 0 || Static501.mapHeight <= local21) {
            ...
            @Pc(98) int local98 = Static521.method6870(arg1, PlayerEntity.self.getBoundSize(), arg3, arg5, local16, arg2, Static480.anIntArray583, arg7, local21, arg6, Static577.A_COLLISION_MAP_ARRAY_1[PlayerEntity.self.level], Static70.anIntArray147, arg4, arg0);
            if (local98 < 1) {
                return false;
            }
