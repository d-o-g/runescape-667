...
public final class Static632 {
    ...
    public static void method8366(@OriginalArg(0) int arg0, @OriginalArg(1) Node_Sub51 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
        ...
        @Pc(23) int local23 = 0;
        @Pc(33) int local33 = arg1.soundVolume * ClientOptions.instance.backgroundSoundVolume.getValue() >> 8;
        ...
        if (local225 != 0 || local236 != 0) {
            local264 = -Camera.yaw - (int) (Math.atan2(local225, local236) * 2607.5945876176133D) - 4096 & 0x3FFF;
            if (local264 > 8192) {
        ...
        @Pc(391) Node_Sub6_Sub2 local391;
        if (arg1.aClass2_Sub6_Sub2_4 != null) {
            ...
            if (arg1.vorbis) {
                ...
                if (local408 != null) {
                    @Pc(415) Node_Sub49_Sub1 local415 = local408.method2247().method7821(Static681.aSampleRateConverter_2);
        ...
        if (arg1.aClass2_Sub6_Sub2_3 != null) {
            ...
            if (!arg1.aBoolean715) {
                ...
                if (local536 != null) {
                    @Pc(543) Node_Sub49_Sub1 local543 = local536.method2247().method7821(Static681.aSampleRateConverter_2);
