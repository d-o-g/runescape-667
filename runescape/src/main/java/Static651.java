...
public final class Static651 {
    ...
    public static void method8517(@OriginalArg(1) boolean arg0, @OriginalArg(2) Class8_Sub2_Sub1_Sub2_Sub2 arg1) {
        ...
        if (arg1.anInt10791 != 0) {
            @Pc(67) String local67 = ModeGame.STELLAR_DAWN == Static392.aModeGame_4 ? LocalisedText.RATING.localise(Static51.anInt1052) : LocalisedText.LEVEL.localise(Static51.anInt1052);
        ...
        for (@Pc(189) int local189 = local176.length - 1; local189 >= 0; local189--) {
            if (local176[local189] != null && (local21.aByte107 == 0 || !local176[local189].equalsIgnoreCase(LocalisedText.ATTACK.localise(Static51.anInt1052)) && !local176[local189].equalsIgnoreCase(LocalisedText.EXAMINE.localise(Static51.anInt1052)))) {
        ...
        for (@Pc(341) int local341 = 0; local341 < local176.length; local341++) {
            if (local176[local341] != null && (local176[local341].equalsIgnoreCase(LocalisedText.ATTACK.localise(Static51.anInt1052)) || local176[local341].equalsIgnoreCase(LocalisedText.EXAMINE.localise(Static51.anInt1052)))) {
