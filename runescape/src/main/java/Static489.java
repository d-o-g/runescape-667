    ...
    public static void method6548() {
        ...
        for (@Pc(12) int local12 = 0; local12 < Static319.aByteArrayArray16.length; local12++) {
            if (Static267.anIntArray329[local12] != -1 && Static319.aByteArrayArray16[local12] == null) {
                Static319.aByteArrayArray16[local12] = Static93.aJs5_16.getfile(0, Static267.anIntArray329[local12]);
            ...
            if (Static266.anIntArray615[local12] != -1 && Static118.aByteArrayArray3[local12] == null) {
                Static118.aByteArrayArray3[local12] = Static93.aJs5_16.getfile(Static22.anIntArrayArray11[local12], 0, Static266.anIntArray615[local12]);
            ...
            if (Static68.anIntArray316[local12] != -1 && Static177.aByteArrayArray5[local12] == null) {
                Static177.aByteArrayArray5[local12] = Static93.aJs5_16.getfile(0, Static68.anIntArray316[local12]);
            ...
            if (Static298.anIntArray367[local12] != -1 && Static421.aByteArrayArray19[local12] == null) {
                Static421.aByteArrayArray19[local12] = Static93.aJs5_16.getfile(0, Static298.anIntArray367[local12]);
            ...
            if (Static376.anIntArray458 != null && Static363.aByteArrayArray22[local12] == null && Static376.anIntArray458[local12] != -1) {
                Static363.aByteArrayArray22[local12] = Static93.aJs5_16.getfile(Static22.anIntArrayArray11[local12], 0, Static376.anIntArray458[local12]);
        ...
        if (Static213.anInt3472 != 0) {
            Static694.method9028(Static163.activeToolkit, Static32.A_LOCALISED_TEXT___12.localise(Static51.anInt1052) + "<br>(100%)", true, Static694.aClass381_13, Static437.aClass14_9);
        }
        ...
        Static21.method8043(Static163.activeToolkit, Static455.anInt6915, Static720.anInt10859, Static501.anInt7568, local310, local430, Static163.activeToolkit.getMaxLights() > 0);
        ...
        if (local430) {
            ...
            Static134.aClass306_Sub1_3.method7881((int[][][]) null, Static163.activeToolkit, (Class110[]) null);
            Static379.method5355(false);
        }
        Static2.aClass306_Sub1_1.method7881(local430 ? Static134.aClass306_Sub1_3.anIntArrayArrayArray17 : null, Static163.activeToolkit, Static577.aClass110Array1);
        if (Static117.anInt2282 == 0) {
            Static314.method4568(true);
        ...
        Static314.method4568(true);
        Static2.aClass306_Sub1_1.method7888(Static163.activeToolkit, local430 ? Static693.aGroundArray2[0] : null, (Ground) null);
        Static2.aClass306_Sub1_1.method7898(false, Static163.activeToolkit);
        Static314.method4568(true);
        if (local430) {
            Static379.method5355(true);
            Static314.method4568(true);
            ...
            Static352.method5180();
            Static314.method4568(true);
            Static134.aClass306_Sub1_3.method7888(Static163.activeToolkit, (Ground) null, Static706.aGroundArray3[0]);
            Static134.aClass306_Sub1_3.method7898(true, Static163.activeToolkit);
            Static314.method4568(true);
            Static379.method5355(false);
        }
