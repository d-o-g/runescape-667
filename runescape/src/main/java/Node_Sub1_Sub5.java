...
public final class Node_Sub1_Sub5 extends TextureOp {
    ...
    public int[][] method9414(@OriginalArg(0) int arg0) {
        ...
        if (super.colourCache.dirty) {
            ...
            for (@Pc(53) int local53 = 0; local53 < EnvironmentLight.anInt9289; local53++) {
