...
public final class Class123 {
    ...
    public final Class28 aClass28_15 = new Class28(256);

    @OriginalMember(owner = "client!fca", name = "c", descriptor = "Lclient!av;")
    public final Class28 aClass28_16 = new Class28(256);
    ...
    public Node_Sub49_Sub1 method2612(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int[] arg2) {
        ...
        @Pc(37) Node_Sub49_Sub1 local37 = (Node_Sub49_Sub1) this.aClass28_16.method738(local30);
        if (local37 != null) {
            return local37;
    ...
    public Node_Sub49_Sub1 method2613(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
        ...
        @Pc(33) Node_Sub49_Sub1 local33 = (Node_Sub49_Sub1) this.aClass28_16.method738(local26);
        if (local33 != null) {
            return local33;
        } else if (arg0 == null || arg0[0] > 0) {
            @Pc(59) Node_Sub53 local59 = (Node_Sub53) this.aClass28_15.method738(local26);
            if (local59 == null) {
