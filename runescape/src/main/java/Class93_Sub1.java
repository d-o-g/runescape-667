...
public final class Class93_Sub1 extends Class93 {
    ...
    public Class93_Sub1(@OriginalArg(0) GlToolkit arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) byte[][] arg4, @OriginalArg(5) int arg5) {
    ...
    public Class93_Sub1(@OriginalArg(0) GlToolkit arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
        super(arg0, 34067, arg1, arg2 * 6 * arg2, false);
        this.anInt2456 = arg2;
        super.aClass19_Sub3_43.method7001(this);
        for (@Pc(28) int local28 = 0; local28 < 6; local28++) {
            OpenGL.glTexImage2Dub(local28 + OpenGL.GL_TEXTURE_CUBE_MAP_POSITIVE_X, 0, super.anInt10911, arg2, arg2, 0, Static391.method5505(super.anInt10911), OpenGL.GL_UNSIGNED_BYTE, null, 0);
        }
        this.method9438(true);
    }

    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Lclient!qha;IIZ[[I)V")
    public Class93_Sub1(@OriginalArg(0) GlToolkit arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int[][] arg4) {
