...
public final class JavaOffscreenSurface implements OffscreenSurface {
    ...
    public void copyTo(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(6) boolean arg4) {
        SurfaceUtil.copy(0, arg2, this.aClass19_Sub2_3.mainDepthBuffer, arg4 ? this.aClass19_Sub2_3.surface.raster : null, this.aClass19_Sub2_3.surface.width, this.depthBuffer, this.width, 0, this.raster, arg3, arg0, arg1);
    }
    ...
    public void copyFrom(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
        SurfaceUtil.copy(arg5, arg2, this.depthBuffer, this.raster, this.width, this.aClass19_Sub2_3.mainDepthBuffer, this.aClass19_Sub2_3.surface.width, arg4, this.aClass19_Sub2_3.surface.raster, arg3, arg0, arg1);
    }
}
