...
public final class Static47 {
    ...
    public static int method1087(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1) {
        @Pc(3) int local3 = arg0[arg1];
        @Pc(5) int local5 = -1;
