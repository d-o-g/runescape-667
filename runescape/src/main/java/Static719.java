...
public final class Static719 {
    ...
    public static void method9117(@OriginalArg(0) TextureSource arg0, @OriginalArg(1) Toolkit arg1) {
        ...
        if (Static273.anInt4403 == 10) {
            ...
            @Pc(79) int local79 = -1;
            @Pc(81) int local81 = -1;
            if (Static30.aClass2_Sub2_Sub13_3.method4088(local77, Static116.areaBaseY + (PlayerEntity.self.anInt10694 >> 9), PlayerEntity.self.level, (PlayerEntity.self.anInt10690 >> 9) + Static691.areaBaseX)) {
            ...
            Static30.aMSITypeList_3.setCache(256, 256);
            Static30.aLocTypeList_3.setRecentUse(4096);
            ...
            if (Static30.aJs5_74.groupExists(Static30.aClass2_Sub2_Sub13_3.aString48 + "_staticelements")) {
                if (!Static30.aJs5_74.requestgroupdownload(Static30.aClass2_Sub2_Sub13_3.aString48 + "_staticelements")) {
                    return;
                }
                Static30.aClass255_3 = Static284.method4103(Static174.aBoolean249, Static30.aJs5_74, Static30.aClass2_Sub2_Sub13_3.aString48 + "_staticelements");
            } else {
