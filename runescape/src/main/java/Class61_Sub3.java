...
public final class Class61_Sub3 extends Class61 implements Interface18 {
    ...
    public Class61_Sub3(@OriginalArg(0) D3DToolkit arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
        ...
        if (this.aClass19_Sub1_Sub1_9.aBoolean413) {
            ...
            this.anInt10425 = IntMath.nextPow2(arg1);
            this.anInt10426 = IntMath.nextPow2(arg2);
        }
        if (arg3) {
    ...
    public Class61_Sub3(@OriginalArg(0) D3DToolkit arg0, @OriginalArg(1) Class92 arg1, @OriginalArg(2) Class397 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
        super(arg0, arg1, arg2, false, arg4 * arg3);
        if (this.aClass19_Sub1_Sub1_9.aBoolean413) {
            this.anInt10426 = arg4;
            this.anInt10425 = arg3;
        } else {
            this.anInt10425 = IntMath.nextPow2(arg3);
            this.anInt10426 = IntMath.nextPow2(arg4);
        }
    ...
    public Class61_Sub3(@OriginalArg(0) D3DToolkit arg0, @OriginalArg(1) Class92 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) byte[] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
        super(arg0, arg1, Static702.aClass397_16, arg4 && arg0.aBoolean414, arg3 * arg2);
        if (this.aClass19_Sub1_Sub1_9.aBoolean413) {
            this.anInt10426 = arg3;
            this.anInt10425 = arg2;
        } else {
            this.anInt10425 = IntMath.nextPow2(arg2);
            this.anInt10426 = IntMath.nextPow2(arg3);
        }
        if (arg4) {
